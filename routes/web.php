...
Route::middleware(['setData', 'auth', 'CustomSetSessionData', 'language', 'timezone', 'CustomAdminSidebarMenu', 'CheckUserLogin'])->group(function () {
...
Route::middleware(['setData', 'auth', 'CustomSetSessionData', 'language', 'timezone'])->group(function () {
