@extends('layouts.app')
@section('title', __('operationsmanagmentgovernment::lang.clients_orders'))

@section('content')

<section class="content-header">
    <h1>
        <span>@lang('operationsmanagmentgovernment::lang.clients_orders')</span>
    </h1>
</section>
                        ...
                        <div class="modal fade" id="replyModal-{{ $message->id }}" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <form action="{{ route('communication.reply', $message->id) }}" method="POST"
