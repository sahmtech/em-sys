...
<section class="content">
                    ...
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'dashboard.data', true, ['class' => 'input-icheck'])
                                !!}
            ...
            <div class="row check_group">
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('is_service_staff', 1, $role->is_service_staff, ['class' =>
                                'input-icheck']) !!} {{ __('restaurant.service_staff') }}
                            </label>
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'view_export_buttons',
                                in_array('view_export_buttons', $role_permissions), [
                                'class' => 'input-icheck',
            ...
            <div class="row check_group">
                ...
                <div class="col-md-12">
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'user.view', in_array('user.view',
                                $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!} {{ __('role.user.view') }}
                            </label>
                    ...
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'user.create', in_array('user.create',
                                $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!} {{ __('role.user.create') }}
                            </label>
                    ...
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'user.update', in_array('user.update',
                                $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!} {{ __('role.user.update') }}
                            </label>
                    ...
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'user.delete', in_array('user.delete',
                                $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!} {{ __('role.user.delete') }}
                            </label>
            ...
            <div class="row check_group">
                ...
                <div class="col-md-12">
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'roles.view', in_array('roles.view',
                                $role_permissions), [
                                'class' => 'input-icheck',
                    ...
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'roles.create', in_array('roles.create',
                                $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!} {{ __('role.add_role') }}
                            </label>
                    ...
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'roles.update', in_array('roles.update',
                                $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!} {{ __('role.edit_role') }}
                            </label>
                    ...
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'roles.delete', in_array('roles.delete',
                                $role_permissions), [
                                'class' => 'input-icheck',
            ...
            <div class="row check_group">
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'access_printers', in_array('access_printers',
                                $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
                ...
                <div class="col-md-12">
                    <div class="radio-group">
                        <div class="col-md-4">
                            <div class="checkbox">
                                <label class="custom_permission_lable">
                                    {!! Form::radio('radio_option[supplier_view]', 'supplier.view',
                                    in_array('supplier.view', $role_permissions), [
                                    'class' => 'input-icheck',
                                    ]) !!}
                    ...
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'supplier.create', in_array('supplier.create',
                                $role_permissions), [
                                'class' => 'input-icheck',
                    ...
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'supplier.update', in_array('supplier.update',
                                $role_permissions), [
                                'class' => 'input-icheck',
                    ...
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'supplier.delete', in_array('supplier.delete',
                                $role_permissions), [
                                'class' => 'input-icheck',
    ...
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="row check_group">
                <div class="col-md-12">
                    <h4>@lang('role.customer')
                        @show_tooltip(__('lang_v1.customer_permissions_tooltip'))</h4>
                </div>
                <div class="col-md-12">
                    <div class="checkbox">
                        <label class="custom_permission_lable">
                ...
                <div class="col-md-12">
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::radio('radio_option[customer_view]', 'customer.view',
                                in_array('customer.view', $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
                    ...
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'customer.create', in_array('customer.create',
                                $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
                    ...
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'customer.update', in_array('customer.update',
                                $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
                    ...
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'customer.delete', in_array('customer.delete',
                                $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
            ...
            <div class="row check_group">
                ...
                <div class="col-md-12">
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'product.view', in_array('product.view',
                                $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
                    ...
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'product.create', in_array('product.create',
                                $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
                    ...
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'product.update', in_array('product.update',
                                $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
                    ...
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'product.delete', in_array('product.delete',
                                $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
                    ...
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'product.opening_stock', in_array('opening_stock',
                                $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
                    ...
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'view_purchase_price',
                                in_array('view_purchase_price', $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
            ...
            <div class="row check_group">
                ...
                <div class="col-md-12">
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::radio('radio_option[purchase_view]', 'purchase.view',
                                in_array('purchase.view', $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'purchase.create', in_array('purchase.create',
                                $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'purchase.update', in_array('purchase.update',
                                $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'purchase.delete', in_array('purchase.delete',
                                $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
            ...
            <div class="row check_group">
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'sell.view', in_array('sell.view',
                                $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
                                {{ __('role.sell.view') }}
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'sell.create', in_array('sell.create',
                                $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
                                {{ __('role.sell.create') }}
                    ...
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'sell.update', in_array('sell.update',
                                $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
                                {{ __('role.sell.update') }}
                    ...
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'sell.delete', in_array('sell.delete',
                                $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
                                {{ __('role.sell.delete') }}
                    ...
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'edit_pos_payment', in_array('edit_pos_payment',
                                $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
                    ...
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'print_invoice', in_array('print_invoice',
                                $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
    ...
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="row check_group">
                <div class="col-md-12">
                    <h4>@lang('sale.sale')
                        @show_tooltip(__('lang_v1.sell_permissions_tooltip'))
                    </h4>
                </div>
                <div class="col-md-12">
                    <div class="checkbox">
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::radio('radio_option[sell_view]', 'direct_sell.view',
                                in_array('direct_sell.view', $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'view_due_sells_only',
                                in_array('view_due_sells_only', $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'direct_sell.access', in_array('direct_sell.access',
                                $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
                                {{ __('lang_v1.add_sell') }}
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'direct_sell.update', in_array('direct_sell.update',
                                $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'direct_sell.delete', in_array('direct_sell.delete',
                                $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
                    ...
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'sell.payments', in_array('sell.payments',
                                $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
                    ...
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'edit_sell_payment', in_array('edit_sell_payment',
                                $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
                    ...
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'delete_sell_payment',
                                in_array('delete_sell_payment', $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
                    ...
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'discount.access', in_array('discount.access',
                                $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
                    ...
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'access_sell_return', in_array('access_sell_return',
                                $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
                    ...
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'edit_invoice_number',
                                in_array('edit_invoice_number', $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
            ...
            <div class="row check_group">
                ...
                <div class="col-md-12">
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::radio('radio_option[so_view]', 'so.view_all', in_array('so.view_all',
                                $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::radio('radio_option[so_view]', 'so.view_own', in_array('so.view_own',
                                $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'so.create', in_array('so.create',
                                $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'so.update', in_array('so.update',
                                $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
                                {{ __('lang_v1.edit_so') }}
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'so.delete', in_array('so.delete',
                                $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
            ...
            <div class="row check_group">
                ...
                <div class="col-md-12">
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::radio('radio_option[draft_view]', 'draft.view_all', in_array('draft.view_all',
                                $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
                    ...
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::radio('radio_option[draft_view]', 'draft.view_own', in_array('draft.view_own',
                                $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
                    ...
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'draft.update', in_array('draft.update',
                                $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
                    ...
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'draft.delete', in_array('draft.delete',
                                $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
            ...
            <div class="row check_group">
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'quotation.update', in_array('quotation.update',
                                $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
                    ...
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'quotation.delete', in_array('quotation.delete',
                                $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
    ...
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="row check_group">
                <div class="col-md-12">
                    <h4>@lang('cash_register.cash_register')
                    </h4>
                </div>
                <div class="col-md-12">
                    <div class="checkbox">
                ...
                <div class="col-md-12">
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'view_cash_register', in_array('view_cash_register',
                                $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
                    ...
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'close_cash_register',
                                in_array('close_cash_register', $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
            ...
            <div class="row check_group">
                ...
                <div class="col-md-12">
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'brand.view', in_array('brand.view',
                                $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
                                {{ __('role.brand.view') }}
                    ...
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'brand.create', in_array('brand.create',
                                $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
                    ...
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'brand.update', in_array('brand.update',
                                $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
                    ...
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'brand.delete', in_array('brand.delete',
                                $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
            ...
            <div class="row check_group">
                ...
                <div class="col-md-12">
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', '', in_array('tax_rate.view', $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
                    ...
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'tax_rate.create', in_array('tax_rate.create',
                                $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
                    ...
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'tax_rate.update', in_array('tax_rate.update',
                                $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
                    ...
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'tax_rate.delete', in_array('tax_rate.delete',
                                $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
            ...
            <div class="row check_group">
                ...
                <div class="col-md-12">
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'unit.view', in_array('unit.view',
                                $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
                                {{ __('role.unit.view') }}
                    ...
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'unit.create', in_array('unit.create',
                                $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
                                {{ __('role.unit.create') }}
                    ...
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'unit.update', in_array('unit.update',
                                $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
                                {{ __('role.unit.update') }}
                    ...
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'unit.delete', in_array('unit.delete',
                                $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
                                {{ __('role.unit.delete') }}
            ...
            <div class="row check_group">
                ...
                <div class="col-md-12">
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'category.view', in_array('category.view',
                                $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
                    ...
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'category.create', in_array('category.create',
                                $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
                    ...
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'category.update', in_array('category.update',
                                $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
                    ...
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'category.delete', in_array('category.delete',
                                $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
            ...
            <div class="row check_group">
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'expense_report.view',
                                in_array('expense_report.view', $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
            ...
            <div class="row check_group">
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'expense.add', in_array('expense.add',
                                $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
                    ...
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'expense.edit', in_array('expense.edit',
                                $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
                    ...
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'expense.delete', in_array('expense.delete',
                                $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
            ...
            <div class="row check_group">
                ...
                <div class="col-md-12">
                    <div class="col-md-4">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'account.access', in_array('account.access',
                                $role_permissions), [
                                'class' => 'input-icheck',
                                ]) !!}
    ...
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="row">
                <div class="col-md-3">
                    <h4>@lang('lang_v1.access_selling_price_groups')
                    </h4>
                </div>
                <div class="col-md-12">
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label class="custom_permission_lable">
                                {!! Form::checkbox('permissions[]', 'access_default_selling_price', true, ['class' =>
                                'input-icheck']) !!}
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="col-md-12">
                <div class="checkbox">
                    <label class="custom_permission_lable">
                        {!! Form::checkbox('permissions[]', 'access_tables', in_array('access_tables',
                        $role_permissions), [
                        'class' => 'input-icheck',
                        ]) !!}
