...
<div class="form-group col-md-3">
    ...
    {!! Form::select('bank_details[bank_name]',$banks ,!empty($bank_details['bank_name']) ? $bank_details['bank_name'] : null, ['class' => 'form-control', 'id' => 'bank_name', 'placeholder' => __( 'lang_v1.bank_name') ]); !!}
</div>
<div class="form-group col-md-3">
