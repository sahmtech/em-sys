...
@section('content')
                ...
                @component('components.widget', ['class' => 'box-solid'])
                    ...
                    <div class="col-md-3">
                        <small>
                            ...
                            <div id="billing_address_div" style="font-size: large;">
                                {!! $walk_in_customer['contact_address'] ?? '' !!}
                            </div>
                        </small>
                    </div>
                    <div class="col-md-3">
                        <small>
                            ...
                            <div id="shipping_address_div" style="font-size: large;">
                                {{ $walk_in_customer['supplier_business_name'] ?? '' }}@if (isset($walk_in_customer['supplier_business_name']))
                                    ,<br>
                                @endif
                                {{ $walk_in_customer['name'] ?? '' }}@if (isset($walk_in_customer['name']))
                                    ,<br>
                                @endif
                                {{ $walk_in_customer['shipping_address'] ?? '' }}
                            </div>
                    ...
                    <div class="col-md-2">
                        {!! Form::label('invoice_type', __('lang_v1.invoice_type') . '  ') !!} <span style="color: red; font-size:15px">*</span>

                        {!! Form::select('invoice_type', [__('lang_v1.cash'), __('lang_v1.due')], null, [
                            'class' => 'form-control ',
                    ...
                    <div class="col-md-3">
                        {!! Form::label('cost_center', __('lang_v1.cost_senter') . '  ') !!} <span style="color: red; font-size:15px">*</span>

                        <select class="form-control select2" style="width: 100%;" name="cost_center_id" id="cost_center_id">
                    ...
                    <div class="col-md-4">
                        {!! Form::label('account_id', __('lang_v1.account_name') . '  ') !!} <span style="color: red; font-size:15px">*</span>
 ...
 --}}
                    ...
                    <div class="col-md-3">
                        {!! Form::label('purchase_order_number', __('lang_v1.purchase_order_number') . '  ') !!}
                        {!! Form::text('purchase_order_number', null, [
                            'class' => 'form-control',
                            'placeholder' => __('lang_v1.purchase_order_number'),
                        ]) !!}
                    </div>
                    <div class="col-md-3">
                        {!! Form::label('delegate', __('lang_v1.delegate') . '  ') !!}
                        {!! Form::text('delegate', null, [
                            'class' => 'form-control',
                            'placeholder' => __('lang_v1.delegate'),
                        ]) !!}
                    </div>

                    <div class="col-md-3">
                        {!! Form::label('Ref', __('lang_v1.Ref') . '  ') !!}
                        {!! Form::text('Ref', null, [
                            'class' => 'form-control',
                            'placeholder' => __('lang_v1.Ref'),
                        ]) !!}
                    </div>
                    <div class="clearfix"></div>
                            ...
                            <table class="table table-condensed table-bordered table-striped table-responsive" id="pos_table">
                                ...
                                <tbody id="tbody">
                                    ...
                                    <td>
                                        ...
                                        <input class="form-control valid" required id="products_"
                                            placeholder="@lang('product.product_name')" name="products_[0][name]" type="text"
                                    ...
                                    <td>
                                        ...
                                        <input type="text" data-min="1" required
                                            ...
                                            value="" name="products_[0][quantity]" data-allow-overselling="true"
                                            data-decimal="1" data-rule-abs_digit="true" id="quantity_"
                                            data-rule-required="fasle"
                                    ...
                                    <td>
                                        ...
                                        <input class="form-control input_number row_discount_amount row_discount_amount_"
                                            id="line_discount_amount_" name="products_[0][line_discount_amount]"
                                            type="text" value="0">
                                        <br>
                                        {!! Form::select(
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#invoice_type").change(function() {
                var selectedinvoice_type = $(this).children("option:selected").val();
                console.log('selectedinvoice_type');
                if (selectedinvoice_type == 1) {
                    $('#payment_row_').hide();
            ...
            $(document).on('click', '#add_product_', function() {
                ...
                $('#tbody').append(
                    ...
                    +
                    '<td><input type="text" data-min="1" class="form-control pos_quantity input_number input_quantity quantity_ valid" value="0" name="products_' +
                    '[' + counter + '][quantity]' +
                    '" data-allow-overselling="true" data-decimal="1" data-rule-abs_digit="true" id="quantity_" data-rule-required="fasle" data-msg-required="validation.custom-messages.this_field_is_required" aria-required="true" aria-invalid="false"></td>' +
                    '<td><input type="text" id="unit_price_" name="products_' + '[' + counter +
                    '][unit_price]' +
                    '" class="form-control pos_unit_price input_number mousetrap valid" value="0" aria-invalid="false"></td>' +
                    '<td><input class="form-control input_number row_discount_amount row_discount_amount_" id="line_discount_amount_" name="products_' +
                    '[' + counter + '][line_discount_amount]' +
                    '" type="text" value="0"><br><select class="form-control row_discount_type_ row_discount_type valid" name="products_' +
                    '[' + counter + '][line_discount_type]' +
                    '" aria-invalid="false"><option value="fixed" selected="selected">@lang('lang_v1.fixed')</option><option value="percentage" selected="selected">@lang('lang_v1.percentage')</option></select>'
                    ...
                    '][unit_price_inc_tax]' +
                    '" class="form-control pos_unit_price_inc_tax input_number valid" value="0" aria-invalid="false"></td>' +
