<div class="modal-dialog modal-lg" id="edit_BankAccounts" role="document">
    <div class="modal-content">
        ...
        <div class="modal-header">
            ...
            <h4 class="modal-title"><i class="fas fa-plus"></i> @lang('lang_v1.edit_BankAccounts')</h4>
        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <section class="content">
                        ...
                        {!! Form::open([
                            'url' =>  action('\App\Http\Controllers\BankAccountsController@update',$bank_account->id),
                            'method' => 'post',
                            'id' => 'journal_add_form',
                        ]) !!}
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        {!! Form::label('bnak_id', __('lang_v1.bank_name') . '  ') !!}<span style="color: red; font-size:10px"> *</span>
                                         ...
                                         {!! Form::select('bnak_id', $banks,$bank_account->bank_id, [
                                            'class' => 'form-control',
                                            'required',
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        {!! Form::text('account_number', $bank_account->account_number, [
                                            'class' => 'form-control',
                                            'required',
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        {!! Form::text('ibn', $bank_account->ibn, [
                                            'class' => 'form-control',
                                            'required',
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        {!! Form::text('account_name', $bank_account->account_name, [
                                            'class' => 'form-control',
                                            'required',
