    ...
    <script>
        $(document).ready(function() {
            $('#expense_location_id').change(function() {
                ...
                if (locationId) {
                    $.ajax({
                        url: '/get-users-by-location', // Ensure this matches the defined route
                        type: 'GET',
                        data: {
                        ...
                        success: function(response) {
                            ...
                            var $expenseFor = $('#expense_for');
                            $expenseFor.empty();
                            $expenseFor.append('<option value="">' + 'Please select' +
                                '</option>'); // Adjust placeholder text
                            $.each(users, function(key, value) {
                                $expenseFor.append('<option value="' + key + '">' +
                                    value + '</option>');
                            });
                            $expenseFor.trigger('change');
                        },
