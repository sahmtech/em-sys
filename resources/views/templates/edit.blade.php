...
@section('content')
            ...
            <form action="{{ route('templates.update', ['id' => $template->id]) }}" method="POST">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="primary_header" name="primary_header">{{ $template->primary_header ?? '' }}</textarea>
                    </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="primary_footer" name="primary_footer">{{ $template->primary_footer ?? '' }}</textarea>
                    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            @json($template->sections).forEach(section => {
                addSectionFromData(section);
                sectionIndex++;
            });

            function addSectionFromData(section) {
                const container = document.getElementById('sections-container');
                const isTwoColumn = section.content == null ? true : false;
                const sectionHTML = isTwoColumn ? getTwoColumnSectionHTML(section) : getSingleColumnSectionHTML(
                    section);

                container.insertAdjacentHTML('beforeend', sectionHTML);
                if (isTwoColumn) {
                    initTinyMCE(`#content_left_${sectionIndex-1}`, 'ltr');
                    initTinyMCE(`#content_right_${sectionIndex-1}`, 'rtl');
                } else {
                    initTinyMCE(`#content_single_${sectionIndex-1}`);
                }
            }



            function getTwoColumnSectionHTML(section) {
                const container = document.getElementById('sections-container');
                ...
                const newSectionHTML = `
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <input type="color" class="form-control" name="sections[${sectionIndex}][header_color]" value=${section.header_color}>
                        </div>
                        <div class="form-group col-md-2">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="${sectionHeaderIdRight}" name="sections[${sectionIndex}][header_right]"
                                    rows="2">${section . header_right}</textarea>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Section Header Left:</label>
                                <textarea class="form-control" id="${sectionHeaderIdLeft}" name="sections[${sectionIndex}][header_left]" rows="2">${section . header_left}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="${sectionIdRight}" name="sections[${sectionIndex}][content_right]" rows="4">${section . content_right}</textarea>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Content Left (English):</label>
                                <textarea class="form-control" id="${sectionIdLeft}" name="sections[${sectionIndex}][content_left]" rows="4">${section . content_left}</textarea>
                            </div>
                        </div>
            ...
            function getSingleColumnSectionHTML(section) {
                const container = document.getElementById('sections-container');
                ...
                <div class="col-md-12 section_block">
                    ...
                    <div class="clearfix"></div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Section Header Right:</label>
                                <textarea class="form-control" id="${sectionHeaderIdRight}" name="sections[${sectionIndex}][header_right]" rows="2">${section . header_right}</textarea>
                            </div>
                        </div>
                            <div class="col-md-6">
                            <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <label>Content:</label>
                            <textarea class="form-control" id="${sectionId}" name="sections[${sectionIndex}][content]" rows="4" >${section . content}</textarea>
                        </div>
                    </div>
                ...
                <div class="col-md-12 section_block" style="margin-bottom: 20px;">
                      ...
                      <div class="clearfix"></div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Content Right (Arabic):</label>
                                    <textarea class="form-control" id="${sectionIdRight}" name="sections[${sectionIndex}][content_right]" rows="4"></textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Content Left (English):</label>
                                    <textarea class="form-control" id="${sectionIdLeft}" name="sections[${sectionIndex}][content_left]" rows="4"></textarea>
                                </div>
                            </div>
            ...
            function addSingleColumnSection() {
                ...
                <div class="col-md-12 section_block">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Content:</label>
                                <textarea class="form-control" id="${sectionId}" name="sections[${sectionIndex}][content]" rows="4"></textarea>
                            </div>
                        </div>
                <input type="hidden" name="sections[${sectionIndex}][order]" value="${sectionIndex + 1}">
