<div class="row">
    ...
    <div class="{{ $col_class }}">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                @php
                    $_payment_method =
                        empty($payment_line['method']) && array_key_exists('cash', $payment_types)
                            ? 'cash'
                            : $payment_line['method'];
                @endphp
    ...
    @if (!empty($show_date))
        <div class="{{ $col_class }}">
            <div class="form-group">
                {!! Form::label("paid_on_from_$row_index", __('lang_v1.paid_date') . '  ') !!} <span style="color: red; font-size:15px">*</span>
                <div class="input-group">
                    <span class="input-group-addon">
                        <i class="fa fa-calendar"></i>
                    </span>
                    {!! Form::text(
                        "payment[$row_index][paid_on_from]",
                        isset($payment_line['paid_on_from']) ? @format_datetime($payment_line['paid_on_from']) : @format_datetime('now'),
