                ...
                <div class="row invoice-info">
                    ...
                    <div class="col-md-6 invoice-col width-50 color-555">
                        ...
                        @if (!empty($receipt_details->display_name))
                            <p>
                                <span
                                    style="font-size:24px; font-weight:900; color:black;">{{ $receipt_details->display_name }}</span>
                        ...
                        <table class="table table-bordered table-no-top-cell-border">
                            <thead>
                                <tr style="background-color: #357ca5 !important; color: white !important; font-size: 20px !important"
                                    ...
                                    <td
                                        style="background-color: #357ca5 !important; color: white !important; width: 65% !important">
                                        {{ $receipt_details->table_product_label }}
                                    </td>

                                    <td
                                        style="background-color: #357ca5 !important; color: white !important; width: 30% !important;">
