...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $cardsPack = [
            ...
            ['id' => 'movements',  'permissions' => $essentialsPermissions, 'title' => __('housingmovements::lang.movement_management'), 'icon' => 'fa fa-car', 'link' =>   action([MovmentDashboardController::class, 'index'])],
