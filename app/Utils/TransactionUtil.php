...
class TransactionUtil extends Util
{
    ...
    public function getReceiptDetails($transaction_id, $location_id, $invoice_layout, $business_details, $location_details, $receipt_printer_type)
    {
        ...
        $comapny_data     = $transaction->business;
        ...
        // Add   an extra line break after all the details (if necessary)
     ...
     * @return object
     */
    public function getListPurchases($business_id, $company_id = null)
    {
        ...
        if ($company_id) {
            $purchases = $purchases->where('transactions.company_id', $company_id);
        }
     ...
     * @return object
     */
    public function getListSells($business_id, $sale_type = 'sell', $company_id = null)
    {
    ...
    public function payContact($request, $format_data = true, $company_id = null)
    {
        ...
        $inputs['payment_for'] = $contact_id ?? $employee_id;
        ...
        if ($contact) {
            ...
            $prefix_type = 'employee_payment';
        }

        $ref_count = $this->setAndGetReferenceCount($prefix_type, $business_id, $company_id);
        ...
        if ($due_payment_type == 'employee' && $is_reverse) {
            $payment_type = 'debit';
        }
        ...
        if ($contact_id && !empty($excess_amount)) {
