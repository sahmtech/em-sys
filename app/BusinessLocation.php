...
class BusinessLocation extends Model
{
    ...
    public static function forDropdownWithCompany($business_id, $company_id = null, $show_all = false, $receipt_printer_type_attribute = false, $append_id = true, $check_permission = true)
    {
        $query = BusinessLocation::where('business_id', $business_id)->where('company_id', $company_id)->Active();
        ...
        // $price_groups = SellingPriceGroup::forDropdown($business_id);
        $price_groups = SellingPriceGroup::forDropdownWithCompany($business_id, $company_id);
    ...
    public function businessLocationPolygonMarkers()
    {
        return $this->hasMany(BusinessLocationPolygonMarker::class, 'business_location_id');
    }
}
