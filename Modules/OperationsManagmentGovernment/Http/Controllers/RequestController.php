...
class RequestController extends Controller
{
    ...
    public function index()
    {
        ...
        return $this->requestUtil->getRequests($departmentIds, $ownerTypes, 'operationsmanagmentgovernment::requests.allRequests', $can_change_status, $can_return_request, $can_show_request);
    }
    /**
