...
Route::middleware('web', 'authh', 'auth', 'SetSessionData', 'language', 'timezone', 'CustomAdminSidebarMenu')->group(function () {
    Route::prefix('generalmanagmentoffice')->group(function () {
        ...
        Route::prefix('notifications')->group(function () {
            Route::get('/index', [Modules\GeneralManagmentOffice\Http\Controllers\NotificationController::class, 'index'])->name('office.notifications.index');
            Route::get('/create', [Modules\GeneralManagmentOffice\Http\Controllers\NotificationController::class, 'create'])->name('office.notifications.create');
            Route::post('/store', [Modules\GeneralManagmentOffice\Http\Controllers\NotificationController::class, 'storeAndSend'])->name('office.notifications.send');
            Route::get('/settings', [Modules\GeneralManagmentOffice\Http\Controllers\NotificationController::class, 'settings'])->name('office.notifications.settings');
            Route::post('/settings.update', [Modules\GeneralManagmentOffice\Http\Controllers\NotificationController::class, 'updateSettings'])->name('office.notifications.settings.update');
        });
