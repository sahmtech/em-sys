...
class NotificationController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('generalmanagmentoffice::notifications.index');
    }
    ...
    public function create()
    {
        ...
        return view('generalmanagmentoffice::notifications.create')->with(compact('users'));
    }
    ...
    public function settings()
    {
        ...
        return view('generalmanagmentoffice::notifications.settings')->with(compact('notificatinoSettings'));
    }
