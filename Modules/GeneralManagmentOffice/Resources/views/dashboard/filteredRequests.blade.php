        ...
        @component('components.widget', ['class' => 'box-primary'])
            <div class="table-responsive">
                <div style="margin-bottom: 10px;">
                    ...
                    @endif
                    @if (auth()->user()->hasRole('Admin#1') || auth()->user()->can('generalmanagmentoffice.return_request'))
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var requests_table = $('#requests_table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('generalmanagmentoffice.getFilteredRequests', ['filter' => ':filter']) }}"
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            ...
                            const requestTypeMap = {
                                ...
                                'advanceSalary': '@lang('
                                                            request.advanceSalary ')',
                                'leavesAndDepartures': '@lang('
                                                            request.leavesAndDepartures ')',
                                'atmCard': '@lang('
                                                            request.atmCard ')',
                                'residenceRenewal': '@lang('
                                                            request.residenceRenewal ')',
                                'residenceIssue': '@lang('
                                                            request.residenceIssue ')',
                                'workerTransfer': '@lang('
                                                            request.workerTransfer ')',
                                'residenceCard': '@lang('
                                                            request.residenceCard ')',
                                'workInjuriesRequest': '@lang('
                                                            request.workInjuriesRequest ')',
                                'residenceEditRequest': '@lang('
                                                            request.residenceEditRequest ')',
                                'baladyCardRequest': '@lang('
                                                            request.baladyCardRequest ')',
                                'mofaRequest': '@lang('
                                                            request.mofaRequest ')',
                                'insuranceUpgradeRequest': '@lang('
                                                            request.insuranceUpgradeRequest ')',
                                'chamberRequest': '@lang('
                                                            request.chamberRequest ')',
                                'WarningRequest': '@lang('
                                                            request.WarningRequest ')',
                                'cancleContractRequest': '@lang('
                                                            request.cancleContractRequest ')',
                                'passportRenewal': '@lang('
                                                            request.passportRenewal ')',
                                'AjirAsked': '@lang('
                                                            request.AjirAsked ')',
                                'AlternativeWorker': '@lang('
                                                            request.AlternativeWorker ')',
                                'TransferringGuaranteeFromExternalClient': '@lang('
                                                            request.TransferringGuaranteeFromExternalClient ')',
                                'Permit': '@lang('
                                                            request.Permit ')',
                                'FamilyInsurace': '@lang('
                                                            request.FamilyInsurace ')',
                                'Ajir_link': '@lang('
                                                            request.Ajir_link ')',
                                'ticketReservationRequest': '@lang('
                                                            request.ticketReservationRequest ')',
                                'authorizationRequest': '@lang('
                                                            request.authorizationRequest ')',
                                'salaryInquiryRequest': '@lang('
                                                            request.salaryInquiryRequest ')',
                                'interviewsRequest': '@lang('
                                                            request.interviewsRequest ')',
                                'moqimPrint': '@lang('
                                                            request.moqimPrint ')',
                                'salaryIntroLetter': '@lang('
                                                            request.salaryIntroLetter ')',
                                'QiwaContract': '@lang('
                                                            request.QiwaContract ')',
                                'ExitWithoutReturnReport': '@lang('
                                                            request.ExitWithoutReturnReport ')',
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            var requestInfoData = [{
                                ...
                                {
                                    label: '{{ __('
                                                                    request.installmentsNumber ') }}',
                                    value: requestInfo.installmentsNumber
                                },

                                {
                                    label: '{{ __('
                                                                    request.workInjuriesDate ') }}',
                                    value: requestInfo.workInjuriesDate
                                },
                                {
                                    label: '{{ __('
                                                                    request.resCardEditType ') }}',
