    ...
    <section class="content-header">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="row widget-statistic">
                <a href="{{ route('generalmanagmentoffice.getFilteredRequests', ['filter' => 'today_requests']) }}">
                    <div class="col-md-3">
                ...
                <a href="{{ route('generalmanagmentoffice.getFilteredRequests', ['filter' => 'pending_requests']) }}">
                    <div class="col-md-3">
                        <div class="custom_card">
                            <div class="widget widget-one_hybrid widget-engagement">
                                <div class="widget-heading">
                ...
                <a href="{{ route('generalmanagmentoffice.getFilteredRequests', ['filter' => 'completed_requests']) }}">
                    <div class="col-md-3">
                        <div class="custom_card">
                            <div class="widget widget-one_hybrid widget-engagement">
                                <div class="widget-heading">
                ...
                <a href="{{ route('generalmanagmentoffice.getFilteredRequests', ['filter' => 'all']) }}">
                    <div class="col-md-3">
                        <div class="custom_card">
                            <div class="widget widget-one_hybrid widget-engagement">
                                <div class="widget-heading">
