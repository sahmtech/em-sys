...
Route::middleware('web', 'authh', 'auth', 'SetSessionData', 'language', 'timezone', 'CustomAdminSidebarMenu')->group(function () {
    Route::prefix('generalmanagement')->group(function () {
        ...
        Route::get('/housin_mmovement_dept_requests', [\Modules\GeneralManagement\Http\Controllers\RequestController::class, 'housinMmovementDept'])->name('housin_mmovement_dept_requests');
        Route::get('/operations_dept_requests', [\Modules\GeneralManagement\Http\Controllers\RequestController::class, 'operationsDept'])->name('operations_dept_requests');

        Route::get('/sales_dept_requests', [\Modules\GeneralManagement\Http\Controllers\RequestController::class, 'salesDept'])->name('sales_dept_requests');
        Route::get('/international_relations_dept_requests', [\Modules\GeneralManagement\Http\Controllers\RequestController::class, 'internationalRelationsDept'])->name('international_relations_dept_requests');
        Route::get('/hr_dept_requests', [\Modules\GeneralManagement\Http\Controllers\RequestController::class, 'humanResourcesDept'])->name('hr_dept_requests');
        Route::get('/hr_dept_apps_requests', [\Modules\GeneralManagement\Http\Controllers\RequestController::class, 'humanResourcesDeptApps'])->name('hr_dept_apps_requests');
        Route::get('/legal_affairs_dept_requests', [\Modules\GeneralManagement\Http\Controllers\RequestController::class, 'legalAffairsDept'])->name('legal_affairs_dept_requests');
        Route::get('/financial_dept_requests', [\Modules\GeneralManagement\Http\Controllers\RequestController::class, 'financialDept'])->name('financial_dept_requests');
        Route::get('/government_relations_dept_requests', [\Modules\GeneralManagement\Http\Controllers\RequestController::class, 'governmentRelationsdeptDept'])->name('government_relations_dept_requests');
        Route::get('/personnel_affairs_dept_requests', [\Modules\GeneralManagement\Http\Controllers\RequestController::class, 'personnelAffairsDept'])->name('personnel_affairs_dept_requests');
        Route::get('/ceo_dept_requests', [\Modules\GeneralManagement\Http\Controllers\RequestController::class, 'ceoDept'])->name('ceo_dept_requests');
        Route::get('/medical_insurance_dept_requests', [\Modules\GeneralManagement\Http\Controllers\RequestController::class, 'medicalInsuranceDept'])->name('medical_insurance_dept_requests');
        Route::get('/payroll_dept_requests', [\Modules\GeneralManagement\Http\Controllers\RequestController::class, 'payrollDept'])->name('payroll_dept_requests');

        //End new Routes
        // TODO:: Refatore this  End
