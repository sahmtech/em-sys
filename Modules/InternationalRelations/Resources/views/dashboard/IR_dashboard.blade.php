...
<div class="row">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-20 col-xs-15" >
                   ...
                   <div class="info-box">
                        ...
                        <span class="info-box-text" style=" text-align: center; font-size:30px;font-family:Arabic Typesetting, sans-serif">أوامر الطلب  </span>
                         
                        <img src="{{ asset('img/request.png') }}"  style="width: 75px;  height: 75px;" alt="">
                ...
                <div class="col-md-4 col-sm-20 col-xs-15" >
                   ...
                   <div class="info-box">
                        ...
                        <span class="info-box-text" style=" text-align: center; font-size:30px;font-family:Arabic Typesetting, sans-serif"> شركة التوظيف</span>
                         
                        <img src="{{ asset('img/team.png') }}"   style="width: 75px;  height: 75px;" alt="">
                        </div>
                ...
                <div class="col-md-4 col-sm-20 col-xs-15" >
                   ...
                   <div class="info-box">
                        ...
                        <span class="info-box-text" style=" text-align: center; font-size:30px;font-family:Arabic Typesetting, sans-serif">طلب الوظيفة  </span>
                         
                        <img src="{{ asset('img/values.png') }}"  style="width: 75px;  height: 75px;" alt="">
                        </div>
               ...
               <div class="info-box">
                    ...
                    <span class="info-box-text" style=" text-align: center; font-size:30px;font-family:Arabic Typesetting, sans-serif">التفويض   </span>
                     
                    <img src="{{ asset('img/delegation.png') }}"  style="width: 75px;  height: 75px;" alt="">
                    </div>
            ...
            <div class="col-md-4 col-sm-20 col-xs-15" >
               ...
               <div class="info-box">
                    ...
                    <span class="info-box-text" style=" text-align: center; font-size:30px;font-family:Arabic Typesetting, sans-serif">العمالة المقترحة   </span>
                     
                    <img src="{{ asset('img/businessman.png') }}"  style="width: 75px;  height: 75px;" alt="">
                    </div>
            ...
            <div class="col-md-4 col-sm-20 col-xs-15" >
               ...
               <div class="info-box">
                    ...
                    <span class="info-box-text" style=" text-align: center; font-size:30px;font-family:Arabic Typesetting, sans-serif">التأشيرات    </span>
                     
                    <img src="{{ asset('img/passport1.png') }}"  style="width: 75px;  height: 75px;" alt="">
                    </div>
            ...
            <div class="col-md-4 col-sm-20 col-xs-15" >
               ...
               <div class="info-box">
                    ...
                    <span class="info-box-text" style=" text-align: center; font-size:30px;font-family:Arabic Typesetting, sans-serif">شركات الطيران    </span>
                     
                    <img src="{{ asset('img/commercial-air-company.png') }}"  style="width: 75px;  height: 75px;" alt="">
                    </div>
              ...
              <!-- /.info-box -->
                ...
                <div class="col-md-4 col-sm-20 col-xs-15" >
                   ...
                   <div class="info-box">
                        ...
                        <span class="info-box-text" style=" text-align: center; font-size:30px;font-family:Arabic Typesetting, sans-serif">الشكاوي </span>
                         
                        <img src="{{ asset('img/complain.png') }}"   style="width: 75px;  height: 75px;" alt="">
                        </div>
                ...
                <div class="col-md-4 col-sm-20 col-xs-15" >
                   ...
                   <div class="info-box">
                        ...
                        <span class="info-box-text" style=" text-align: center; font-size:30px;font-family:Arabic Typesetting, sans-serif">شكاوي مدير القسم </span>
                         
                        <img src="{{ asset('img/complaint.png') }}"  style="width: 75px;  height: 75px;" alt="">
                        </div>
                ...
                <div class="col-md-4 col-sm-20 col-xs-15" >
                   ...
                   <div class="info-box">
                        ...
                        <span class="info-box-text" style=" text-align: center; font-size:30px;font-family:Arabic Typesetting, sans-serif">شكاوي مدير الدائرة </span>
                         
                        <img src="{{ asset('img/bad-review.png') }}"   style="width: 75px;  height: 75px;" alt="">
                        </div>
                ...
                <div class="col-md-4 col-sm-20 col-xs-15" >
                   ...
                   <div class="info-box">
                        ...
                        <span class="info-box-text" style=" text-align: center; font-size:30px;font-family:Arabic Typesetting, sans-serif">التذاكر   </span>
                         
                        <img src="{{ asset('img/passport.png') }}"  style="width: 75px;  height: 75px;" alt="">
                        </div>
                ...
                <div class="col-md-4 col-sm-20 col-xs-15" >
                   ...
                   <div class="info-box">
                        ...
                        <img src="{{ asset('img/report.png') }}"  style="width: 75px;  height: 75px;" alt="">
                        </div>
