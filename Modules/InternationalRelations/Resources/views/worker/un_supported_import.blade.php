        ...
        <div class="row">
            <div class="col-sm-12">
                @component('components.widget', ['class' => 'box-primary'])
                    {!! Form::open([
                        'url' => action([\Modules\InternationalRelations\Http\Controllers\WorkerController::class, 'postImportWorkers']),
                        'method' => 'post',
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <a href="{{ asset('files/import_workers_template.xls') }}" class="btn btn-success" download><i
                ...
                @component('components.widget', ['class' => 'box-primary', 'title' => __('lang_v1.instructions')])
                    ...
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td>{{ trans('essentials::lang.single') . ':single' }},{{ trans('essentials::lang.married') . ':married' }}
                            </td>
                        </tr>
