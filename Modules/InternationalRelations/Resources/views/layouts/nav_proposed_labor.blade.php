            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    @if (auth()->user()->hasRole('Admin#1') ||
                            auth()->user()->can('sales.view_proposed_workers'))
                    ...
                    @endif
                    @if (auth()->user()->hasRole('Admin#1') ||
                            auth()->user()->can('sales.view_accepted_workers'))
                    ...
                    @endif
                    @if (auth()->user()->hasRole('Admin#1') ||
                            auth()->user()->can('sales.view_under_trialPeriod_workers'))
                    ...
                    @endif
                    @if (auth()->user()->hasRole('Admin#1') ||
                            auth()->user()->can('sales.view_unaccepted_workers'))
