<div class="modal-dialog modal-xl no-print" role="document">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title"> @lang('internationalrelations::lang.add_deleation')
            </h4>
        </div>
    ...
    $(document).ready(function() {
        $('#saveButton').click(function() {
            ...
            $('table tbody tr:gt(0)').each(function() {
                ...
                if (product_id !== undefined && agency_id !== undefined && target_quantity !== undefined) {
                data2.push({
        ...
        function addRow() {
            ...
            clonedRow.find('.add_row').removeClass('add_row btn-success').addClass('remove_row btn-danger').text('Remove');
