                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            ...
                            if (data == 1 &&
                                ...
                                buttonsHtml += `@if (auth()->user()->hasRole('Admin#1') ||auth()->user()->can('ceomanagment.return_request'))
                            <button class="btn btn-danger btn-sm btn-return" data-request-id="${row.process_id}">
                                @lang('followup::lang.return_the_request')
                            </button>@endif`;
                            }

                            buttonsHtml += `@if (auth()->user()->hasRole('Admin#1') ||auth()->user()->can('ceomanagment.view_request'))
