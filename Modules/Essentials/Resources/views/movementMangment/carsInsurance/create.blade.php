<div class="modal-dialog modal-lg" id="add_insurance_model" role="document">
    <div class="modal-content">
        ...
        <div class="modal-header">
            ...
            <h4 class="modal-title"><i class="fas fa-plus"></i> @lang('housingmovements::lang.add_insurance')</h4>
        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <section class="content">
                        ...
                        {!! Form::open([
                            'url' => action('\Modules\Essentials\Http\Controllers\CarInsuranceController@store'),
                            'method' => 'post',
                            'id' => 'carType_add_form',
                        ]) !!}
