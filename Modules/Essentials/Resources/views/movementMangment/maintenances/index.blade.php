@extends('layouts.app')
@section('title', __('housingmovements::lang.carMaintenances'))

@section('content')

    <section class="content-header">
        <h1>
            <span>@lang('housingmovements::lang.carMaintenances')</span>
        </h1>
    </section>
                    ...
                    @slot('tool')
                        <div class="box-tools">
                            <a class="btn btn-block btn-primary"
                                href="{{ action('Modules\Essentials\Http\Controllers\CarsMaintenanceController@create') }}">
                    ...
                    @slot('tool')
                        <div class="box-tools">
                            <a class="btn btn-primary pull-right m-5 btn-modal"
                                href="{{ action('Modules\Essentials\Http\Controllers\CarsMaintenanceController@create') }}"
                                data-href="{{ action('Modules\Essentials\Http\Controllers\CarsMaintenanceController@create') }}"
                                data-container="#add_carMaintenances_model">
                                <i class="fas fa-plus"></i> @lang('messages.add')</a>
                        </div>
                    @endslot
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            carMaintenances_table = $('#carMaintenances_table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '{{ route('essentials.cars-maintenances') }}',
                    data: function(d) {
