...
<section class="content">
                ...
                <table class="table table-bordered table-striped" id="workers_table_timesheet"
                    ...
                    <thead>
                        <tr>
                            ...
                            <th style="width: 50px;">المعرف</th>
                            <th style="width:100px;">@lang('essentials::lang.name')</th>

                            <th style="width:75px;">@lang('essentials::lang.nationality')</th>

                            @if ($user_type == 'worker')
                            <th style="width:100px;">@lang('essentials::lang.residence_permit')
                                @lang('essentials::lang.border_no') </th>
                            ...
                            <th style="width:100px;">
                                @lang('essentials::lang.identity_card_number') / @lang('essentials::lang.border_no')
                            </th>
                            @endif
                            @if ($user_type != 'remote_employee' && $user_type != 'worker')
                            <th style="width:100px;">@lang('essentials::lang.profession')</th>
                            <th style="width:100px;">@lang('essentials::lang.job_title')</th>
                            @endif

                            <th style="width:50px;">@lang('essentials::lang.work_days')</th>
                            <th style="width:50px;">@lang('essentials::lang.salary')</th>
                            ...
                            <th style="background-color: rgb(185, 182, 182); width:75px;">
                                @lang('essentials::lang.total_additions')</th>
                            @endif
                            <th style="background-color: rgb(185, 182, 182); width:75px;">
                                @lang('essentials::lang.final_salary')</th>
                            @if ($user_type != 'remote_employee')
                    ...
                    <tbody>
                        ...
                        <tr class="payroll_row">
                            ...
                            <td name="identity_card_number"><a>{{ $payroll['identity_card_number'] }}</a>
                                {!! Form::hidden('payrolls[' . $index . '][identity_card_number]',
                                $payroll['identity_card_number'], [
                                'data-index' => $index,
                            ...
                            <td name="job_title">{{ $payroll['job_title'] }}
                                {!! Form::hidden('payrolls[' . $index . '][job_title]', $payroll['job_title'], [
                                'data-index' => $index,
                            ...
                            <td class="editable" name="work_days"> <span contenteditable="true"
                                    data-index="{{ $index }}" data-field="work_days">{{ $payroll['work_days'] }}</span>
                            ...
                            <td name="salary"><span data-index="{{ $index }}" data-field="salary">{{ $payroll['salary']
                                    }}</span>
                            ...
                            <td name="housing_allowance"><span data-index="{{ $index }}"
                                ...
                                {!! Form::hidden('payrolls[' . $index . '][housing_allowance]',
                            ...
                            <td name="transportation_allowance"><span data-index="{{ $index }}"
                                    data-field="transportation_allowance">{{ $payroll['transportation_allowance']
                                    }}</span>
                                {!! Form::hidden('payrolls[' . $index . '][transportation_allowance]',
                            ...
                            <td name="other_allowance"><span data-index="{{ $index }}" data-field="other_allowance">{{
                                    $payroll['other_allowance'] }}</span>
                                {!! Form::hidden('payrolls[' . $index . '][other_allowance]',
                            ...
                            <td class="editable" name="violations"> <span contenteditable="true"
                                    data-index="{{ $index }}" data-field="violations">{{ $payroll['violations']
                                    }}</span>
                            ...
                            <td class="editable" name="absence"> <span contenteditable="true" data-index="{{ $index }}"
                                ...
                                {!! Form::hidden('payrolls[' . $index . '][absence_deduction]',
                            ...
                            <td name="total_amount_absence"><span data-index="{{ $index }}"
                                ...
                                {!! Form::hidden('payrolls[' . $index . '][total_amount_absence]',
                                $payroll['total_amount_absence'], [
                                'data-index' => $index,
                                'data-field' => 'total_amount_absence',
                                'class' => 'form-hidden',
                                ]) !!}
                            </td>
                            <td class="editable" name="late"> <span contenteditable="true" data-index="{{ $index }}"
                            ...
                            <td name="total_amount_of_delay"><span data-index="{{ $index }}"
                                ...
                                {!! Form::hidden('payrolls[' . $index . '][total_amount_of_delay]',
                                $payroll['total_amount_of_delay'], [
                                'data-index' => $index,
                            ...
                            <td class="editable" name="other_deductions"> <span contenteditable="true"
                                    data-index="{{ $index }}" data-field="other_deductions">{{
                                    $payroll['other_deductions'] }}</span>
                                {!! Form::hidden('payrolls[' . $index . '][other_deductions]',
                            ...
                            <td class="editable" name="loan"> <span contenteditable="true" data-index="{{ $index }}"
                            ...
                            <td style="background-color: rgb(185, 182, 182);" name="total_deduction"><span
                                    data-index="{{ $index }}" data-field="total_deduction">{{
                                    $payroll['total_deduction'] }}</span>
                                {!! Form::hidden('payrolls[' . $index . '][total_deduction]',
                            ...
                            <td class="editable" name="over_time_hours"> <span contenteditable="true"
                                    data-index="{{ $index }}" data-field="over_time_hours">{{
                                    $payroll['over_time_hours'] }}</span>
                                {!! Form::hidden('payrolls[' . $index . '][over_time_hours]',
                                $payroll['over_time_hours'], [
                                'data-index' => $index,
                                'data-field' => 'over_time_hours',
                                'class' => 'form-hidden',
                                ]) !!}
                                {!! Form::hidden('payrolls[' . $index . '][over_time_hours_addition]',
                                $payroll['over_time_hours_addition'], [
                                'data-index' => $index,
                            ...
                            <td name="total_amount_over_time_hours"><span data-index="{{ $index }}"
                                    ...
                                    $payroll['total_amount_over_time_hours'] }}</span>
                                {!! Form::hidden(
                            ...
                            <td class="editable" name="additional_addition"> <span contenteditable="true"
                                    data-index="{{ $index }}" data-field="additional_addition">{{
                                    $payroll['additional_addition'] }}</span>
                                {!! Form::hidden('payrolls[' . $index . '][additional_addition]',
                            ...
                            <td class="editable" name="other_additions"> <span contenteditable="true"
                                    data-index="{{ $index }}" data-field="other_additions">{{
                                    $payroll['other_additions'] }}</span>
                                {!! Form::hidden('payrolls[' . $index . '][other_additions]',
                                $payroll['other_additions'], [
                                'data-index' => $index,
                            ...
                            <td style="background-color: rgb(185, 182, 182);" name="total_additions"><span
                                    data-index="{{ $index }}" data-field="total_additions">{{
                                    $payroll['total_additions'] }}</span>
                                {!! Form::hidden('payrolls[' . $index . '][total_additions]',
                            ...
                            <td style="background-color: rgb(185, 182, 182);" name="final_salary"><span
                                    data-index="{{ $index }}" data-field="final_salary">{{ $payroll['final_salary']
                                    }}</span>
                            ...
                            <td class="editable" name="payment_method"> <span contenteditable="true"
                                    data-index="{{ $index }}" data-field="payment_method">{{ $payroll['payment_method']
                                    }}</span>
                            ...
                            @endif
                            <td class="editable" name="notes"> <span contenteditable="true" data-index="{{ $index }}"
                            ...
                            {!! Form::hidden('payrolls[' . $index . '][timesheet_user_id]',
                            $payroll['timesheet_user_id'] ?? null, [
                            'data-index' => $index,
                            ...
                            {{--
                            {!! Form::hidden('payrolls[' . $index . '][timesheet_group_id]',
                            $payroll['timesheet_group_id'] ?? null, [
                            'data-index' => $index,
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button type="button" class="close" data-dismiss="modal"
                        aria-label="@lang('essentials::lang.close')">
                ...
                <div class="modal-body">
                    <div style="margin-top: 20px;">
                        ...
                        <p><strong>@lang('essentials::lang.emp_number'):</strong> <span id="worker_emp_number"></span>
                        </p>
                        <p><strong>@lang('essentials::lang.contry_nationality'):</strong> <span id="nationality"></span>
                        </p>
                        ...
                        <p><strong>@lang('essentials::lang.housing_allowance'):</strong> <span
                                id="housing_allowance"></span></p>
                        <p><strong>@lang('essentials::lang.transportation_allowance'):</strong> <span
                                id="transportation_allowance"></span></p>
                        <p><strong>@lang('essentials::lang.other_allowance'):</strong> <span
                                id="other_allowance"></span></p>
                        ...
                        <p><strong>@lang('essentials::lang.sub_status'):</strong> <span id="worker_sub_status"></span>
                        </p>
                        <p><strong>@lang('essentials::lang.id_proof_number'):</strong> <span
                                id="worker_id_proof_number"></span></p>
                        <p><strong>@lang('essentials::lang.residence_permit_expiration'):</strong> <span
                                id="worker_residence_permit_expiration"></span>
                        </p>
                        <p><strong>@lang('essentials::lang.passport_number'):</strong> <span
                                id="worker_passport_number"></span></p>
                        <p><strong>@lang('essentials::lang.passport_expire_date'):</strong> <span
                                id="worker_passport_expire_date"></span></p>
                        <p><strong>@lang('essentials::lang.border_number'):</strong> <span id="worker_border_no"></span>
                        </p>
                        <p><strong>@lang('essentials::lang.company_name'):</strong> <span
                                id="worker_company_name"></span></p>
                        <p><strong>@lang('essentials::lang.assigned_to'):</strong> <span id="worker_assigned_to"></span>
                        </p>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" id="edit-worker-info"
                        class="btn btn-primary">@lang('essentials::lang.edit')</button>
    ...
    {{-- <div class="modal fade" id="infoModal" tabindex="-1" role="dialog" aria-labelledby="infoModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" id="edit-worker-modal"
                        class="btn btn-primary">@lang('essentials::lang.edit')</button>
    ...
    <div class="modal fade" id="salaryInfoModal" tabindex="-1" role="dialog" aria-labelledby="salaryInfoModal"
        ...
        <div class="modal-dialog modal-lg" role="document">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="salaryInfoModalLabel">@lang('essentials::lang.view_salary_info') &
                        @lang('essentials::lang.personal_info')</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div id="workerInfoBody">
                                <p><strong>@lang('essentials::lang.full_name'):</strong> <span
                                        id="worker_full_name"></span></p>
                                <p><strong>@lang('essentials::lang.emp_number'):</strong> <span
                                        id="worker_emp_number"></span></p>
                                <p><strong>@lang('essentials::lang.contry_nationality'):</strong> <span
                                        id="nationality"></span></p>

                                <p><strong>@lang('essentials::lang.status'):</strong> <span id="worker_status"></span>
                                </p>
                                <p><strong>@lang('essentials::lang.sub_status'):</strong> <span
                                        id="worker_sub_status"></span></p>
                                <p><strong>@lang('essentials::lang.id_proof_number'):</strong> <span
                                        id="worker_id_proof_number"></span></p>
                                <p><strong>@lang('essentials::lang.residence_permit_expiration'):</strong> <span
                                ...
                                <p><strong>@lang('essentials::lang.passport_number'):</strong> <span
                                        id="worker_passport_number"></span></p>
                                <p><strong>@lang('essentials::lang.passport_expire_date'):</strong> <span
                                        id="worker_passport_expire_date"></span>
                                </p>
                                <p><strong>@lang('essentials::lang.border_number'):</strong> <span
                                        id="worker_border_no"></span></p>
                                <p><strong>@lang('essentials::lang.company_name'):</strong> <span
                                        id="worker_company_name"></span></p>
                                <p><strong>@lang('essentials::lang.assigned_to'):</strong> <span
                                        id="worker_assigned_to"></span></p>
                    ...
                    <div class="modal-footer">
                        <button type="button"
                            class="btn btn-sm btn-primary edit-salary">@lang('essentials::lang.edit')</button>
