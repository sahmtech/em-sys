...
<script type="text/javascript">
    $(document).ready(function() {
            ...
            var requests_table = $('#requests_table').DataTable({
                ...
                ajax: {
                    url: "{{ route('pay_advanceSalaryRequest') }}"
                },
...
<script>
    $(document).ready(function() {
            // تفعيل Select2 مع خاصية البحث
            $('#worker').select2({
                dropdownParent: $('#addRequestModal'),
                width: '100%',
                placeholder: '@lang("essentials::lang.name")', // لاضافة placeholder
                allowClear: true,  // للسماح بحذف الاختيار
            });
        });
</script>
