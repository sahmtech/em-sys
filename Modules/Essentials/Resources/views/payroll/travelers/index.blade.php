                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        "render": function(data, type, row) {
                            ...
                            // Check if worker_documents exists and has items, and if visa.file exists
                            if ((!row.worker_documents || row.worker_documents.length === 0) && (!
                                    row.visa || !row.visa.file)) {
                                return '@lang('housingmovements::lang.no_files')';
                            }

                            // Safely iterate over worker_documents if it exists
                            ...
                            // Check for visa file and append its link if available
