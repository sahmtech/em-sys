    ...
    <section class="content-header">
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            ...
            <div class="row widget-statistic" style="padding-bottom:20px">
                <a href="{{ route('essentials.getFilteredRequests', ['filter' => 'today_requests']) }}">
                    <div class="col-md-3">
                ...
                <a href="{{ route('essentials.getFilteredRequests', ['filter' => 'pending_requests']) }}">
                    <div class="col-md-3">
                        <div class="custom_card custom_card_requests">
                            <div class="widget widget-one_hybrid widget-engagement">
                                <div class="widget-heading">
                ...
                <a href="{{ route('essentials.getFilteredRequests', ['filter' => 'completed_requests']) }}">
                    <div class="col-md-3">
                        <div class="custom_card custom_card_requests">
                            <div class="widget widget-one_hybrid widget-engagement">
                                <div class="widget-heading">
                ...
                <a href="{{ route('essentials.getFilteredRequests', ['filter' => 'all']) }}">
                    <div class="col-md-3">
                        <div class="custom_card custom_card_requests">
                            <div class="widget widget-one_hybrid widget-engagement">
                                <div class="widget-heading">
