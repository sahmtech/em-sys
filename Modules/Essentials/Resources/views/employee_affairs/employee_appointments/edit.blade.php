...
<div class="modal-dialog" role="document">
    ...
    {!! Form::open(['route' => ['updateAppointment', $Appointmet->id], 'method' => 'put', 'id' => 'edit_Appointmet_form']) !!}
      ...
      <div class="modal-body">
        <div class="row">
            <div class="form-group col-md-6">
                ...
                {!! Form::select('employee',$users,  $Appointmet->employee_id, ['class' => 'form-control', 'placeholder' => __('essentials::lang.select_employee'), 'required']) !!}
            </div>
            <div class="form-group col-md-6">
                {!! Form::label('department', __('essentials::lang.department') . ':*') !!}
                {!! Form::select('department',$departments,  $Appointmet->department_id, ['class' => 'form-control', 'placeholder' => __('essentials::lang.select_department'), 'required']) !!}
            </div>
            <div class="form-group col-md-6">
                {!! Form::label('location', __('essentials::lang.location') . ':*') !!}
                {!! Form::select('location',$business_locations,  $Appointmet->business_location_id, ['class' => 'form-control', 'placeholder' => __('essentials::lang.select_location'), 'required']) !!}
            </div>
     
            <div class="form-group col-md-6">
                {!! Form::label('profession', __('sales::lang.profession') . ':*') !!}
                {!! Form::select('profession',$professions, $Appointmet->profession_id, ['class' => 'form-control', 'required',
                   'placeholder' => __('sales::lang.profession'),'id' => 'professionSelect']); !!}
                   
              </div>
            <div class="form-group col-md-6">
                {!! Form::label('specialization', __('sales::lang.specialization') . ':*') !!}
                {!! Form::select('specialization',$specializations , $Appointmet->specialization_id, ['class' => 'form-control', 'required',
