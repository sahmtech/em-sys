...
@section('content')
    ...
    <section class="content">
                ...
                @component('components.filters', ['title' => __('report.filters'), 'class' => 'box-solid'])
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="admissions_status_filter" required
                                id="admissions_status_filter" style="width: 100%;">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="admissions_type_filter" required
                                id="admissions_type_filter" style="width: 100%;">
                                <option value="all">@lang('lang_v1.all')</option>
        ...
        <div class="row">
                    ...
                    @slot('tool')
                        <div class="box-tools">
                            ...
                            <button type="button" class="btn btn-block btn-primary  btn-modal" data-toggle="modal"
                                data-target="#addAdmissionsToWorkModal">
            ...
            <div class="modal fade" id="addAdmissionsToWorkModal" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    {!! Form::date('admissions_date', null, [
                                        'class' => 'form-control',
                                        'placeholder' => __('essentials::lang.admissions_date'),
                                        'required',
                                    ]) !!}
                                </div>
