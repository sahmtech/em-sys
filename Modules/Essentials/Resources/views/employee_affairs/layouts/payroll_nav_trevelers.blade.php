        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    auth()->user()->can('housingmovements.new_arrival_for_workers') ||
                    auth()->user()->can('payrolls.new_arrival_for_workers'))
                    ...
                    <li @if (request()->segment(2) == 'pay_progress') class="active" @endif>
                        <a href="{{ route('pay_progress') }}">
