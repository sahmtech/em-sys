...
@section('content')
    <style>
        ...
        .custom_card {
            flex: 1;
            min-width: 0;
            /* Allow cards to shrink beyond their minimum content width */
        }
    </style>
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                ...
                <div class="row widget-statistic">
                                ...
                                <div class="widget widget-one_hybrid widget-engagement">
                                    <div class="widget-heading">
                                        ...
                                        <div class="w-title">
                                            ...
                                            <div>
                                                <p class="w-value"></p>
                                                <h4 style="color:#fff" id="counter-0">{{ $last15_expire_date_residence }}
                                                </h4>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    @if (auth()->user()->can('essentials.view_all_expire_resdiency'))
                        <div class="col-md-3 " onclick="redirectToAllEndedResidency()"
                            style="cursor: pointer; padding:15px;">
                            <div class="custom_card">
                                <div class="widget widget-one_hybrid widget-engagement">
                                    <div class="widget-heading">
                                        ...
                                        <div class="w-title">
                                            ...
                                            <div>
                                                <p class="w-value"></p>
                                                <h5 style="color:#fff">{{ __('essentials::lang.all_finish_residency') }}
                                                </h5>
                                            </div>
                                            <div>
                                                <p class="w-value"></p>
