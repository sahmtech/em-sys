  <div class="modal-dialog modal-lg" id="edit_manage_travel_categories" role="document">
    <div class="modal-content">
        ...
        <div class="modal-header">
            ...
            <h4 class="modal-title"><i class="fas fa-edit"></i>@lang('essentials::lang.manage_travel_categories')</h4>
