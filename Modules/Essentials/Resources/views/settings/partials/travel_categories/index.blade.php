...
@section('content')
    ...
    <section class="content">
        ...
        <div class="modal fade" id="edit_manage_travel_categories" tabindex="-1" role="dialog">
            ...
            <div class="modal fade" id="addTravelCategorieModal" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    {!! Form::text('employee_ticket_value', null, [
                                        'class' => 'form-control',
                                        'placeholder' => __('essentials::lang.employee_ticket_value'),
                                        'required',
                                    ]) !!}
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    {!! Form::text('wife_ticket_value', null, [
                                        'class' => 'form-control',
                                        'placeholder' => __('essentials::lang.wife_ticket_value'),
                                        'required',
                                    ]) !!}
                                </div>
                                <div class="form-group col-md-6">
                                    {!! Form::label('children_ticket_value', __('essentials::lang.children_ticket_value') . ':*') !!}
                                    {!! Form::text('children_ticket_value', null, [
                                        'class' => 'form-control',
                                        'placeholder' => __('essentials::lang.children_ticket_value'),
                                        'required',
                                    ]) !!}
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    {!! Form::textarea('details', null, [
                                        'class' => 'form-control',
                                        'placeholder' => __('essentials::lang.details'),
                                        'rows' => 2,
                                    ]) !!}
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    {!! Form::select(
                                        'is_active',
                                        ['1' => __('essentials::lang.is_active'), '0' => __('essentials::lang.is_unactive')],
                                        null,
                                        ['class' => 'form-control'],
                                    ) !!}
                                </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            var travel_categories_table = $('#travel_categories_table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('hrm.travel_categories') }}',
                columns: [{
                        data: 'name'
                    },
                    {
