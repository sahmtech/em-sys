...
<section class="content-header">
    <h1>
        <span>@lang('essentials::lang.entitlement_types')</span>
    </h1>
</section>
...
<section class="content">
    @component('components.widget', ['class' => 'box-primary'])
        ...
        <div class="box-tools">
            ...
            <button type="button" class="btn btn-block btn-primary" data-toggle="modal" data-target="#addEntitlementModal">
    ...
    <div class="modal fade" id="addEntitlementModal" tabindex="-1" role="dialog" aria-labelledby="gridSystemModalLabel">
