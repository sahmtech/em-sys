...
@section('content')
    ...
    <section class="content">
            ...
            @slot('tool')
                <div class="box-tools">
                    ...
                    <button type="button" class="btn btn-block btn-primary" data-toggle="modal"
                        data-target="#addAllowancesAndDeductionsModal">
        ...
        <div class="modal fade allowances_and_deductions_modal" tabindex="-1" role="dialog"
            aria-labelledby="gridSystemModalLabel">
        </div>
        <!-- Modal for adding a new  -->
        <div class="modal fade" id="addAllowancesAndDeductionsModal" tabindex="-1" role="dialog"
            aria-labelledby="gridSystemModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    {!! Form::open([
                        'url' => action([\Modules\Essentials\Http\Controllers\EssentialsAllowanceController::class, 'store']),
                        'method' => 'POST',
                        'id' => 'addRowForm',
                    ]) !!}
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                {!! Form::select(
                                    'amount_type',
                                    ['fixed' => __('essentials::lang.fixed'), 'percent' => __('essentials::lang.percent')],
                                    null,
                                    ['class' => 'form-control', 'required'],
                                ) !!}
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::date('applicable_date', null, [
                                    'class' => 'form-control',
                                    'placeholder' => __('essentials::lang.applicable_date'),
                                    'required',
                                ]) !!}
                            </div>
