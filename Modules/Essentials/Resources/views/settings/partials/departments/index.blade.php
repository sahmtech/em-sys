                ...
                <table class="table table-bordered table-striped" id="departments_table">
                    <thead>
                        <tr>
                            ...
                            <th>@lang('essentials::lang.manager_deputy')</th>
                        ...
                        <form action="{{ route('storeManager', ':id') }}" method="POST" id="appointmentForm">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-primary"
                                    id="saveAppointmentBtn">@lang('messages.save')</button>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <form action="{{ route('manager_delegating', ':id') }}" method="POST" id="delegatingForm">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-primary"
                                    id="saveDelegatingBtn">@lang('messages.save')</button>
                                <button type="button" class="btn btn-default" data-dismiss="modal">@lang('messages.close')</button>
                            </div>
                        </form>
                        <div id="modalContent"></div>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        {!! Form::text('name', null, [
                                            'class' => 'form-control',
                                            'placeholder' => __('essentials::lang.name'),
                                            'required',
                                            'id' => 'department_name',
                                        ]) !!}
                                    </div>
                                    ...
                                    <div class="form-group col-md-6 parentLevelContainer" style="display: none;">
                                        ...
                                        {!! Form::select('parent_level', $parent_departments, null, [
                                            'class' => 'form-control',
                                            'placeholder' => __('essentials::lang.parent_level'),
                                            'required',
                                            'id' => 'department_parent_department_id',
                                            'size' => 1,
                                        ]) !!}
                                    </div>
                                    <div class="form-group col-md-6">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        {!! Form::select('manager', $users, null, [
                                            'class' => 'form-control',
                                            'placeholder' => __('essentials::lang.select_employee'),
                                            'required',
                                            'id' => 'manager_id',
                                    ...
                                    <div class="form-group  col-md-6">
                                        {!! Form::label('profession', __('essentials::lang.job_title') . ':*') !!}
                                        {!! Form::select('profession', $professions, null, [
                                            'class' => 'form-control manager_profession-select',
                                            'required',
                                            'placeholder' => __('essentials::lang.job_title'),
                                            'id' => 'profession_id',
                                        ]) !!}
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group  col-md-6">
                                        ...
                                        {!! Form::select('profession2', $professions, null, [
                                            'class' => 'form-control profession-select',
                                            'required',
                                            'placeholder' => __('essentials::lang.job_title'),
                                            'id' => 'delegate_profession_id',
                                        ]) !!}
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        {!! Form::date('start_date2', null, [
                                            'class' => 'form-control',
                                            'placeholder' => __('essentials::lang.start_date'),
                                            'required',
                                            'id' => 'delegate_start_from',
                                        ]) !!}
                                    </div>
                                    <div class="form-group col-md-6">
                                        {!! Form::label('end_date2', __('essentials::lang.end_date') . ':*') !!}
                                        {!! Form::date('end_date2', null, [
                                            'class' => 'form-control',
                                            'placeholder' => __('essentials::lang.end_date'),
                                            'required',
                                            'id' => 'delegate_end_at',
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#departments_table').on('click', '.open-modal', function() {
                ...
                var rowId = $(this).data('row-id');
                $('#addDeputyModal').data('row-id', rowId);
                var formAction = "{{ route('storeDeputy', ':id') }}".replace(':id', rowId);
                $('#DeputyForm').attr('action', formAction);
            });


            $('#saveDeputyBtn').on('click', function() {

                var formData = $('#DeputyForm').serialize();
                $.ajax({
                    url: $('#DeputyForm').attr('action'),
                    type: 'POST',
                    data: formData,
                    success: function(result) {
                        if (result.success == true) {
                            toastr.success(result.msg);
                            $('#addDeputyModal').modal('hide');
                            departments_table.ajax.reload();
                        } else {
                            toastr.error(result.msg);
                        }
