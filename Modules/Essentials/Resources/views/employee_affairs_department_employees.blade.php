@extends('layouts.app')
@section('title', __('essentials::lang.department_employees'))
...
@section('content')
    ...
    <section class="content-header">
        <h1>
            <span>@lang('essentials::lang.department_employees')</span>
        </h1>
    </section>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#employees_table').DataTable({
                ...
                ajax: {
                    url: "{{ route('employee_affairs_department_employees') }}",
                    data: function(d) {
