            ...
            <div class="row">
                <div class="col-md-12">
                    <ul class="nav nav-tabs">
                        @if (auth()->user()->hasRole('Admin#1') || auth()->user()->can('essentials.view_timesheet_groups'))
                            <li class="active">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="payrolls_groups_tab">
                            <div class="col-md-12">
                                @if (auth()->user()->hasRole('Admin#1') || auth()->user()->can('essentials.create_timesheet'))
        ...
        <div class="modal fade" id="payroll_modal" tabindex="-1" role="dialog" aria-labelledby="gridSystemModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    {!! Form::open([
                        'url' => route('hrm.agentTimeSheet.create'),
                        'method' => 'get',
