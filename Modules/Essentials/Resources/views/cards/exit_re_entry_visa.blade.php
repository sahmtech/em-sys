@extends('layouts.app')
@section('title', __('essentials::lang.return_visa'))
        ...
        @component('components.widget', ['class' => 'box-primary'])
            @slot('tool')
                <div class="box-tools">
                    ...
                    @if (auth()->user()->can('essentials.add_return_visa_muqeem'))
                        <button type="button" class="btn btn-block btn-primary  btn-modal" data-toggle="modal"
                            data-target="#returnVisaModal">
        ...
        <div class="modal fade" id="returnVisaModal" tabindex="-1" role="dialog" aria-labelledby="returnVisaModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    {!! Form::open([
                        'url' => action([\Modules\Essentials\Http\Controllers\EssentialsCardsController::class, 'post_exit_re_entry_visa']),
                        'method' => 'post',
                        'id' => 'bulk_edit_form',
                    ]) !!}
