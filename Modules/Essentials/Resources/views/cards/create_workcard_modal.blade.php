    <div class="modal fade" id="createWorkCardModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                   ...
                   <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::select('workcard_duration_input',
                                    $durationOptions, null, ['class' => 'form-control',
                                    'style'=>'height:36px','id'=>'workcard_duration_input', 'required',
