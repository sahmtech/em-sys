            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    @if (auth()->user()->hasRole('Admin#1') || auth()->user()->can('housingmovements.new_arrival_for_workers'))
                        <li @if (request()->segment(2) == 'insurance_travelers') class="active" @endif>
                            <a href="{{ route('insurance_travelers') }}">
                    ...
                    @if (auth()->user()->hasRole('Admin#1') || auth()->user()->can('housingmovements.housed'))
                        <li @if (request()->segment(2) == 'insurance_housed_workers') class="active" @endif>
                            <a href="{{ route('insurance_housed_workers') }}">
                    ...
                    @if (auth()->user()->hasRole('Admin#1') || auth()->user()->can('housingmovements.advanceSalaryRequest'))
                        <!--3 -->
                        <li @if (request()->segment(2) == 'insurance_advanceSalaryRequest') class="active" @endif>

                            <a href="{{ route('insurance_advanceSalaryRequest') }}">
                    ...
                    @if (auth()->user()->hasRole('Admin#1') || auth()->user()->can('housingmovements.medicalExamination'))
                        <!-- 4 -->
                        <li @if (request()->segment(2) == 'insurance_medicalExamination') class="active" @endif>
                            <a href="{{ route('insurance_medicalExamination') }}">
                    ...
                    @if (auth()->user()->hasRole('Admin#1') || auth()->user()->can('housingmovements.medicalInsurance'))
                        <!-- 5 -->
                        <li @if (request()->segment(2) == 'insurance_medicalInsurance') class="active" @endif>
                            <a href="{{ route('insurance_medicalInsurance') }}">
                    ...
                    @if (auth()->user()->hasRole('Admin#1') || auth()->user()->can('housingmovements.workCardIssuing'))
                        <!-- 6 -->
                        <li @if (request()->segment(2) == 'insurance_workCardIssuing') class="active" @endif>
                            <a href="{{ route('insurance_workCardIssuing') }}">
                    ...
                    @if (auth()->user()->hasRole('Admin#1') || auth()->user()->can('housingmovements.SIMCard'))
                        <!-- 7 -->
                        <li @if (request()->segment(2) == 'insurance_SIMCard') class="active" @endif>
                            <a href="{{ route('insurance_SIMCard') }}">
                    ...
                    @if (auth()->user()->hasRole('Admin#1') || auth()->user()->can('housingmovements.bankAccount'))
                        <!-- 8 -->
                        <li @if (request()->segment(2) == 'insurance_bankAccountsForLabors') class="active" @endif>
                            <a href="{{ route('insurance_bankAccountsForLabors') }}">
                    ...
                    @if (auth()->user()->hasRole('Admin#1') || auth()->user()->can('housingmovements.contract'))
                        <!-- 9 -->
                        <li @if (request()->segment(2) == 'insurance_QiwaContract') class="active" @endif>
                            <a href="{{ route('insurance_QiwaContract') }}">
                    ...
                    @if (auth()->user()->hasRole('Admin#1') || auth()->user()->can('housingmovements.residencyAdd&Print'))
                        <!-- 10 -->
                        <li @if (request()->segment(2) == 'insurance_residencyPrint') class="active" @endif>
                            <a href="{{ route('insurance_residencyPrint') }}">
                    ...
                    @if (auth()->user()->hasRole('Admin#1') || auth()->user()->can('housingmovements.residencyDelivery'))
                        <!-- 11 -->
                        <li @if (request()->segment(2) == 'insurance_residencyDelivery') class="active" @endif>
                            <a href="{{ route('insurance_residencyDelivery') }}">
