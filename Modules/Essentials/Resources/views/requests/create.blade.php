    ...
    <div class="modal-body">
        <div class="row">
            <div class="form-group col-md-6">
                {!! Form::label('worker_id', __('essentials::lang.employee') . ':*') !!}
                {!! Form::select('worker_id', $workers, null, ['class' => 'form-control', 'required', 'style'=>' height: 40px' ,'placeholder' => __('essentials::lang.select_employee')]) !!}
            </div>
            <div class="form-group col-md-6">
