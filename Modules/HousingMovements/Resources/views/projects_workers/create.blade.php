...
@section('title', __('housingmovements::lang.add_new_worker'))

@section('content')

  
        <section class="content-header">
            <h1>@lang('housingmovements::lang.add_new_worker')</h1>
        </section>


    <section class="content">
        {!! Form::open(['route' => 'store_project_worker', 'enctype' => 'multipart/form-data']) !!}
        <div class="row">
            <div class="col-md-12">
                <div class="col-md-12 box box-primary">
                    <h4>@lang('housingmovements::lang.basic_info'):</h4>
                    <div class="col-md-4">
                ...
                @include('housingmovements::projects_workers.personal_info')
