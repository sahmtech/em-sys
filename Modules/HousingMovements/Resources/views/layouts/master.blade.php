...
<html lang="{{ app()->getLocale() }}" dir="{{in_array(session()->get('user.language', config('app.locale')), config('constants.langs_rtl')) ? 'rtl' : 'ltr'}}">
    <head>
        ...
        <title>@yield('title') - {{ Session::get('business.name') }}</title>
         ...
         @include('housingmovements::layouts.partials.css')
    ...
    <body class="@if($pos_layout) hold-transition lockscreen @else hold-transition skin-@if(!empty(session('business.theme_color'))){{session('business.theme_color')}}@else{{'blue-light'}}@endif sidebar-mini @endif">
        <div class="wrapper thetop">
            ...
            @if(!$pos_layout)
                 @include('housingmovements::layouts.partials.header')
                @include('housingmovements::layouts.sidebarh&m')
             
            @else
                 @include('housingmovements::layouts.partials.header-pos')
            @endif
            ...
            @if(!$pos_layout)
                 @include('housingmovements::layouts.partials.footer')
            @else
                 @include('housingmovements::layouts.partials.footer_pos')
            @endif
        ...
        @endif
         ...
         @include('housingmovements::layouts.partials.javascripts')
