                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                __('housingmovements::lang.building_name'), 'required']) !!}
                            </div>
                            <div class="form-group col-md-6">
                                {!! Form::label('address', __('housingmovements::lang.address') . ':') !!}
                                {!! Form::text('address', null, ['class' => 'form-control', 'placeholder' =>
                                __('housingmovements::lang.address'),]) !!}
                            </div>
                            <div class="form-group col-md-6">
                                {!! Form::label('city', __('housingmovements::lang.city') . ':*') !!}
                                {!! Form::select('city', $cities, null, ['class' => 'form-control', 'style'=>' height:36px;
                                width:100%', 'placeholder' => __('housingmovements::lang.city'), 'required']) !!}
                            </div>
                            <div class="clearfix"></div>
                            <div class="form-group col-md-6">
                                {!! Form::label('guard', __('housingmovements::lang.building_guard') . ':') !!}
                                {!! Form::select('guard[]', $users2, null, ['class' => 'form-control select2', 'style' =>
                                'width:100%;height:40px;', 'multiple' => 'multiple', 'placeholder' =>
                                __('housingmovements::lang.building_guard')]) !!}
                            </div>
                            <div class="form-group col-md-6">
                                {!! Form::label('supervisor', __('housingmovements::lang.building_supervisor') . ':') !!}
                                {!! Form::select('supervisor[]', $users2, null, ['class' => 'form-control select2',
                                'style'=>'width:100%;height:40px;', 'style'=>'height:40px; width:100%', 'multiple' =>
                                'multiple', 'placeholder' => __('housingmovements::lang.building_supervisor'), ]) !!}
                            </div>
                            <div class="form-group col-md-6">
                                {!! Form::label('cleaner', __('housingmovements::lang.building_cleaner') . ':') !!}
                                {!! Form::select('cleaner[]', $users2, null, ['class' => 'form-control select2',
                                'style'=>'width:100%;height:40px;', 'multiple' => 'multiple', 'placeholder' =>
                                __('housingmovements::lang.building_cleaner'), ]) !!}
                            </div>
                            <div class="form-group col-md-6">
                                {!! Form::label('building_end_date', __('housingmovements::lang.building_end_date') . ':')
                                !!}
                                {!! Form::date('building_end_date', null, ['class' => 'form-control ',
                                'style'=>'width:100%;height:36px;', 'placeholder' =>
                                __('housingmovements::lang.building_end_date'), ]) !!}
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    $('#addBuildingModal').on('shown.bs.modal', function(e) {
        $('#guard').select2({
            dropdownParent: $('#addBuildingModal'),
            width: '100%',
        });
        $('#supervisor').select2({
            dropdownParent: $('#addBuildingModal'),
