...
@section('content')
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <div class="modal fade building_modal" tabindex="-1" role="dialog" aria-labelledby="gridSystemModalLabel">
            </div>
            ...
            $('body').on('click', '.open-edit-modal', function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#editbuildingModal input[name="address"]').val(data.building
                            .address);
                        $('#editbuildingModal select[name="city"]').val(data.building.city_id)
                            .trigger('change');
                        $('#editbuildingModal select[name="guard"]').val(data.building.guard_id)
                            .trigger('change');
                        $('#editbuildingModal select[name="supervisor"]').val(data.building
                            .supervisor_id).trigger('change');
                        $('#editbuildingModal select[name="cleaner"]').val(data.building
