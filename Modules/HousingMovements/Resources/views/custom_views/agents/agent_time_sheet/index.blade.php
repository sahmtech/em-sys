            ...
            <div class="row">
                <div class="col-md-12">
                    <ul class="nav nav-tabs">
                        @if (auth()->user()->hasRole('Admin#1') || auth()->user()->can('housingmovements.view_timesheet_groups'))
                            <li class="active">
                        ...
                        @endif
                        {{-- @if (auth()->user()->hasRole('Admin#1') || auth()->user()->can('housingmovements.view_timesheet_users'))
                            <li>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="payrolls_groups_tab">
                            <div class="col-md-12">
                                @if (auth()->user()->hasRole('Admin#1') || auth()->user()->can('housingmovements.create_timesheet'))
        ...
        <div class="modal fade" id="payroll_modal" tabindex="-1" role="dialog" aria-labelledby="gridSystemModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    {!! Form::open([
                        'url' => route('housingmovements.agentTimeSheet.create'),
                        'method' => 'get',
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                payrolls_table = $('#payrolls_table').DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: "{{ route('housingmovements.agentTimeSheetUsers') }}",
                    },
                    columnDefs: [{
                        orderable: false,
                        searchable: false,
                ...
                payroll_group_table = $('#payroll_group_table').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('housingmovements.agentTimeSheetGroups') }}",
                    columns: [{
                            data: 'name',
                            name: 'name'
                        },
