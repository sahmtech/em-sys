...
class TimeSheetController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('housingmovements::custom_views.agents.agent_time_sheet.index', compact('workers', 'companies', 'departments', 'designations', 'projects'));
    }
    ...
    public function editTimeSheet($id)
    {
        ...
        $action = 'edit';
        return view('housingmovements::custom_views.agents.agent_time_sheet.payroll_group')->with(compact('project_id', 'employee_ids', 'group_name', 'id', 'date', 'month_year', 'payrolls', 'action'));
    }
