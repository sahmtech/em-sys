...
class TimeSheetController extends Controller
{
    ...
    public function create()
    {
        ...
        $action = 'create';
        return view('housingmovements::custom_views.agents.agent_time_sheet.payroll_group')->with(compact('employee_ids', 'group_name', 'date', 'month_year', 'payrolls', 'action'));
    }
    ...
    public function showTimeSheet($id)
    {
        ...
        return view('housingmovements::custom_views.agents.agent_time_sheet.show', compact('timesheetGroup', 'timesheetUsers'));
    }
}
