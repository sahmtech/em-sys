...
class ContractAppendixController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($request->hasFile('file_contract_appendices')) {
                $file = $request->file('file_contract_appendices');
                $filePath = $file->store('/contract_appendice_files');
            }
            $input['file_contract_appendices'] = $filePath;
