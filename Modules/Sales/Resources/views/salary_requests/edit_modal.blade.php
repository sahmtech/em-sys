...
<div class="modal fade item_modal" tabindex="-1" role="dialog" aria-labelledby="gridSystemModalLabel">
 ...
 <div class="modal fade" id="editsalaryRequestModal" tabindex="-1" role="dialog" aria-labelledby="gridSystemModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
        {!! Form::open(['route' => ['salay_request.update', 'salaryId'], 'enctype' => 'multipart/form-data']) !!}
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group col-md-6">
                                ...
                                {!! Form::date('arrival_period', null,
                                     ['class' => 'form-control']) !!}
                    </div>
                            
                    <div class="form-group col-md-6">
                                {!! Form::label('recruitment_fees', __('sales::lang.recruitment_fees') . ':') !!}
                                {!! Form::number('recruitment_fees', null,
                                     ['class' => 'form-control']) !!}
                    </div>
                    <div class="form-group col-md-6">
