      ...
      <div class="modal-body">
        <div class="row">
            <div class="form-group col-md-12">
                ...
                {!! Form::select('contract',$contracts, null, ['class' => 'form-control', 'placeholder' => __('sales::lang.contract_number')]) !!}
            </div>
                    ...
                    <div class="form-group col-md-12">
                        ...
                        {!! Form::textarea('notes', $appendix->notes, ['class' => 'form-control', 'placeholder' => __('sales::lang.notes'), 'rows' => 2]) !!}
                    </div>
        </div>
