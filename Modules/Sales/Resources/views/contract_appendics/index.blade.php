            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        {!! Form::select('contract',$contracts, null, ['class' => 'form-control', 'placeholder' => __('sales::lang.contract_number'), 'required']) !!}
                    </div>
                    <div class="form-group col-md-12">
                    ...
                    <div class="form-group col-md-6">
                        <button type="button" class="btn btn-primary" id="addButton" data-toggle="modal" data-target="#addItemModal">
