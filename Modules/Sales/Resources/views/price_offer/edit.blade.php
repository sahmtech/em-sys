                        ...
                        <div class="form-group">
                            <div class="input-group">
                                <span class="input-group-addon">
                                    ...
                                    'id' => 'location_id', 'style' => 'height:40px;', 
                                    'required']); !!}
                ...
                @endif
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            <div class="form-group col-md-10">
                                ...
                                {!! Form::select('contact_id',$leads,$offer_price->contact_id, ['class' => 'form-control','style' => 'height:40px;',  'placeholder' => __('sales::lang.select_customer'), 'required']) !!}
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            ], $offer_price->status, ['class' => 'form-control', 'style' => 'height:40px;', 'required',
                    ...
                    <div class="col-md-4">
                        ...
                        {!! Form::Number('down_payment',$offer_price->down_payment, ['class' => 'form-control', 'style' => 'height:40px;', 'required',
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::text('transaction_date', $offer_price->transaction_date, ['class' => 'form-control','style' => 'height:40px;',  'required']); !!}
                            </div>
                        </div>
                    </div>
