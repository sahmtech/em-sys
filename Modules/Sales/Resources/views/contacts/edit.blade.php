                ...
                <br>
                                                        <div class="col-md-6">
                                                                        ...
                                                                        {!! Form::label('first_name', __('sales::lang.first_name_cs') . ':') !!}
                                                                            ...
                                                                            @if(isset($contactSigners) && !empty( $contactSigners->first_name) )
                                                                                {!! Form::text('first_name_cs', $contactSigners->first_name ?? "", ['class' => 'form-control', 'placeholder' => __('sales::lang.first_name_cs')]); !!}
                                                                            @else
                                                        ...
                                                        <div class="col-md-6">
                                                                        ...
                                                                        {!! Form::label('last_name', __('sales::lang.last_name_cs') . ':') !!}
                                                                            ...
                                                                            @if(isset($contactSigners) && !empty( $contactSigners->last_name) )
                                                                                {!! Form::text('last_name_cs', $contactSigners->last_name ?? "", ['class' => 'form-control', 'placeholder' => __('sales::lang.last_name_cs')]); !!}
                                                                            @else
                                                        ...
                                                        <div class="col-md-6">
                                                                        ...
                                                                        {!! Form::label('english_name', __('sales::lang.english_name_cs') . ':') !!}
                                                                            ...
                                                                            @if(isset($contactSigners) && !empty( $contactSigners->english_name))
                                                                                {!! Form::text('english_name_cs', $contactSigners->english_name ?? "", ['class' => 'form-control', 'placeholder' => __('sales::lang.english_name_cs')]); !!}
                                                                            @else
                                                                                {!! Form::text('english_name_cs', "", ['class' => 'form-control', 'placeholder' => __('sales::lang.english_name_cs')]); !!}
                                                                            @endif
                                                                            </div>
                                                                        </div>
                                                        </div> 
                                                        ...
                                                        <div class="col-md-6">
                                                                        ...
                                                                        {!! Form::label('nationality_cs', __('sales::lang.nationality_cs') . ':') !!}
                                                                            ...
                                                                            {!! Form::select('nationality_cs', $nationalities, $contactSigners->country->id, ['class' => 'form-control','style'=>'height:40px' ,'placeholder' => __('Select Nationality')]) !!}
                                                                            @else
                                                                            {!! Form::select('nationality_cs', $nationalities,null, ['class' => 'form-control','style'=>'height:40px' ,'placeholder' => __('Select Nationality')]) !!}
                                                                             @endif
                                                                            </div>
                                                                        </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                                        ...
                                                                        {!! Form::label('email_cs', __('sales::lang.email_cs') . ':') !!}
                                                                            ...
                                                                            <input type="hidden" id="hidden_id" value="{{ !empty($contactSigners->email) ? $contactSigners->email : '' }}">

                                                                            @if(isset($contactSigners)  && !empty( $contactSigners->email))
                                                                                {!! Form::text('email_cs', $contactSigners->email ?? "", ['class' => 'form-control', 'placeholder' => __('sales::lang.email_cs')]); !!}
                                                                            @else
                                                        ...
                                                        <div class="col-md-6">
                                                                        ...
                                                                        {!! Form::label('identityNO_cs', __('sales::lang.identityNO_cs') . ':') !!}
                                                                            ...
                                                                            <input type="hidden" id="hidden_id" value="{{ !empty($contactSigners->id_proof_number) ? $contactSigners->id_proof_number : '' }}">

                                                                            @if(isset($contactSigners)   && !empty( $contactSigners->id_proof_number) )
                                                                                {!! Form::text('identityNO_cs', $contactSigners->id_proof_number ?? "", ['class' => 'form-control', 'placeholder' => __('sales::lang.identityNO_cs')]); !!}
                                                                            @else
...
<div class="col-md-6">
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            <input type="hidden" id="username_cs_id" value="{{ !empty($contactSigners->username) ? $contactSigners->username : '' }}">
            @if(isset($contactSigners) && !empty($contactSigners->username))
                {!! Form::text('username_cs', $contactSigners->username ?? "", ['id' => 'username_cs', 'class' => 'form-control', 'placeholder' => __('sales::lang.username_cs')]); !!}
            @else
                {!! Form::text('username_cs', "", ['id' => 'username_cs', 'class' => 'form-control', 'placeholder' => __('sales::lang.username_cs')]); !!}
            @endif
        </div>
    </div>
</div>
                                                        ...
                                                        <div class="col-md-6">
                                                                        ...
                                                                        {!! Form::label('first_name', __('sales::lang.first_name_cf') . ':') !!}
                                                                            ...
                                                                            @if(isset($contactFollower) && !empty( $contactFollower->first_name) )
                                                                                {!! Form::text('first_name_cf', $contactFollower->first_name ?? "", ['class' => 'form-control', 'placeholder' => __('sales::lang.first_name_cf')]); !!}
                                                                            @else
                                                        ...
                                                        <div class="col-md-6">
                                                                        ...
                                                                        {!! Form::label('last_name', __('sales::lang.last_name_cf') . ':') !!}
                                                                            ...
                                                                            @if(isset($contactFollower) && !empty( $contactFollower->last_name) )
                                                                                {!! Form::text('last_name_cf', $contactFollower->last_name ?? "", ['class' => 'form-control', 'placeholder' => __('sales::lang.last_name_cf')]); !!}
                                                                            @else
                                                        ...
                                                        <div class="col-md-6">
                                                                        ...
                                                                        {!! Form::label('english_name', __('sales::lang.english_name_cf') . ':') !!}
                                                                            ...
                                                                            @if(isset($contactFollower) && !empty( $contactFollower->english_name))
                                                                                {!! Form::text('english_name_cf', $contactFollower->english_name ?? "", ['class' => 'form-control', 'placeholder' => __('sales::lang.english_name_cf')]); !!}
                                                                            @else
                                                        ...
                                                        <div class="col-md-6">
                                                                        ...
                                                                        {!! Form::label('email_cf', __('sales::lang.email_cf') . ':') !!}
                                                                            ...
                                                                            @if(isset($contactFollower) && !empty( $contactFollower->email) )
                                                                                {!! Form::text('email_cf', $contactFollower->email ?? "", ['class' => 'form-control', 'placeholder' => __('sales::lang.email_cf')]); !!}
                                                                            @else
                ...
                <strong>@lang('sales::lang.allow_login')</strong>
                                                        ...
                                                        <div class="col-md-6">
                                                                        ...
                                                                        {!! Form::label('username_cf', __('sales::lang.username_cf') . ':') !!}
                                                                            ...
                                                                            <input type="hidden" id="username_cf_id" value="{{ !empty($contactFollower->username) ? $contactFollower->username : '' }}">

                                                                            @if(isset($contactFollower) && !empty( $contactFollower->username)  )
                                                                                {!! Form::text('username_cf', $contactFollower->username ?? "", ['class' => 'form-control','id' => 'username_cf', 'placeholder' => __('sales::lang.username_cf')]); !!}
                                                                            @else
                                                                                {!! Form::text('username_cf', "", ['class' => 'form-control','id' => 'username_cf', 'placeholder' => __('sales::lang.username_cf')]); !!}
                                                                            @endif
                                                                            </div>
                                                                        </div>
                                                            </div>
