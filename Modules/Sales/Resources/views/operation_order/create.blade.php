...
<section class="content-header">
    <h1>@lang('sales::lang.create_sale_operation')</h1>
</section>
...
<div class="col-md-9">
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            {!! Form::select('contact_id', $leads, null, ['class' => 'form-control', 'style' => 'height:36px', 'placeholder' => __('sales::lang.select_customer'), 'required', 'id' => 'customer-select']) !!}
        </div>
    </div>
</div>
...
<div class="col-md-9">
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            {!! Form::text('operation_order_no', null, ['class' => 'form-control', 'placeholder' => __('sales::lang.example_operation_order_number')]); !!}
        </div>
    </div>
</div>
...
<div class="col-md-9">
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            {!! Form::select('status', $status, null, ['class' => 'form-control', 'style' => 'height:36px',
                 'placeholder' => __('sales::lang.select_status'), 'required', 'id' => 'status-select']) !!}
        </div>
    </div>
</div>
