...
<section class="content-header">
    <h1>
        <span>@lang('followup::lang.workInjuriesRequest')</span>
    </h1>
</section>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
     ...
     var requests_table=$('#requests_table').DataTable({
        ...
        ajax: { url: "{{ route('workInjuriesRequest') }}"},
          ...
          
                {
                    ...
                    render: function (data, type, row) {
                        if (data == 1) {
                            return '@if(auth()->user()->hasRole("Admin#1") || auth()->user()->can("followup.return_the_request_workInjuriesRequest"))<button class="btn btn-danger btn-sm btn-return" data-request-id="' + row.id + '">@lang('followup::lang.return_the_request')</button>@endif';
