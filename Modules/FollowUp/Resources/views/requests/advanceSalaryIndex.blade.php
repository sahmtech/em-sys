...
<section class="content-header">
    <h1>
        <span>@lang('followup::lang.advanceSalary')</span>
    </h1>
</section>
                ...
                <table class="table table-bordered table-striped" id="requests_table">
                    <thead>
                        <tr>
                            ...
                            <th>@lang('followup::lang.advSalaryAmount')</th>
                            <th>@lang('followup::lang.monthlyInstallment')</th>
        ...
        ajax: { url: "{{ route('advanceSalary') }}"},
              ...
              
                {
                    ...
                    render: function (data, type, row) {
                        if (data == 1 && row.start) {
                            return '@if(auth()->user()->hasRole("Admin#1") || auth()->user()->can("followup.return_the_request_advanceSalary"))<button class="btn btn-danger btn-sm btn-return" data-request-id="' + row.id + '">@lang('followup::lang.return_the_request')</button>@endif';
