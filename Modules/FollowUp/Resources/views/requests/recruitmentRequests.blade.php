        ...
        <div class="modal fade" id="addrequestModal" tabindex="-1" role="dialog" aria-labelledby="gridSystemModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    {!! Form::open(['route' => 'storeRecruitmentRequest' , 'enctype' => 'multipart/form-data']) !!}
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                {!! Form::select('nationlity',$nationalities ,null, ['class' => 'form-control', 'required','style'=>' height: 40px',
                                    'placeholder' => __('essentials::lang.nationlity')]); !!}
                            </div>
                            <div class="form-group col-md-6">
                                {!! Form::label('date', __('essentials::lang.required_date') . ':') !!}
                                {!! Form::date('date', null, ['class' => 'form-control', 'style'=>' height: 40px' , 'placeholder' => __('essentials::lang.required_date')]) !!}
                            </div>
                            <div class="form-group col-md-6">
                                {!! Form::label('quantity', __('essentials::lang.quantity') . ':*') !!}
                                {!! Form::number('quantity', null, ['class' => 'form-control','style'=>' height: 40px' , 'required', 'placeholder' => __('essentials::lang.quantity')]) !!}
                            </div>
                            <div class="form-group col-md-6">
