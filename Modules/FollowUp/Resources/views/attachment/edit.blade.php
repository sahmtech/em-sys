<div class="modal-dialog modal-lg" id="edit_document_model" role="document">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title"><i class="fas fa-edit"></i> @lang('followup::lang.edit_attachment')</h4>
        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <section class="content">
                        ...
                        {!! Form::open([
                            'url' => action('Modules\FollowUp\Http\Controllers\FollowupAttachmentController@update', $document->id),
                            'method' => 'put',
                            'id' => 'doc_add_form',
                        ]) !!}
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('name_ar', $document->name_ar, [
                                        'class' => 'form-control',
                                        'required',
