                        ...
                        <div class="info-box">
                            ...
                            <div class="info-box-content"
                                ...
                                <span class="info-box-text"
                                    style=" text-align: center; font-size:30px;font-family:Arabic Typesetting, sans-serif">المشاريع
                                </span>
                    ...
                    <div class="col-md-4 col-sm-20 col-xs-15">
                        ...
                        <div class="info-box">
                            ...
                            <div class="info-box-content"
                                ...
                                <span class="info-box-text"
                                    style=" text-align: center; font-size:30px;font-family:Arabic Typesetting, sans-serif">
                                    عمال المشاريع</span>

                                <img src="{{ asset('img/request.png') }}" style="width: 75px;  height: 75px;"
                                    alt="">
                            </div>
                    ...
                    <div class="col-md-4 col-sm-20 col-xs-15">
                        ...
                        <div class="info-box">
                            ...
                            <div class="info-box-content"
                                ...
                                <span class="info-box-text"
                                    style=" text-align: center; font-size:30px;font-family:Arabic Typesetting, sans-serif">نافذة
                                    العميل </span>

                                <img src="{{ asset('img/planning.png') }}" style="width: 75px;  height: 75px;"
                                    alt="">
                            </div>
                    ...
                    <div class="col-md-4 col-sm-20 col-xs-15">
                        ...
                        <div class="info-box">
                            ...
                            <div class="info-box-content"
                                ...
                                <span class="info-box-text"
                                    style=" text-align: center; font-size:30px;font-family:Arabic Typesetting, sans-serif">الطلبات
                                </span>

                                <img src="{{ asset('img/complain.png') }}" style="width: 75px;  height: 75px;"
                                    alt="">
                            </div>
                    ...
                    <div class="col-md-4 col-sm-20 col-xs-15">
                        ...
                        <div class="info-box">
                            ...
                            <div class="info-box-content"
                                ...
                                <span class="info-box-text"
                                    style=" text-align: center; font-size:30px;font-family:Arabic Typesetting, sans-serif">مهام
                                    الموظفين </span>
                    ...
                    <div class="col-md-4 col-sm-20 col-xs-15">
                        ...
                        <div class="info-box">
                            ...
                            <div class="info-box-content"
                                ...
                                <span class="info-box-text"
                                    style=" text-align: center; font-size:30px;font-family:Arabic Typesetting, sans-serif">طلب
                                    الوظيفة </span>

                                <img src="{{ asset('img/customer-care.png') }}" style="width: 75px;  height: 75px;"
                                    alt="">
                            </div>
                    ...
                    <div class="col-md-4 col-sm-20 col-xs-15">
                        ...
                        <div class="info-box">
                            ...
                            <div class="info-box-content"
                                ...
                                <span class="info-box-text"
                                    style=" text-align: center; font-size:30px;font-family:Arabic Typesetting, sans-serif">التقارير
                                </span>
                    ...
                    <div class="col-md-4 col-sm-20 col-xs-15">
                        ...
                        <div class="info-box">
                            ...
                            <div class="info-box-content"
                                ...
                                <span class="info-box-text"
                                    style=" text-align: center; font-size:30px;font-family:Arabic Typesetting, sans-serif">
                                    تنبيهات العمليات </span>

                                <img src="{{ asset('img/notification.png') }}" style="width: 75px;  height: 75px;"
                                    alt="">
                            </div>
