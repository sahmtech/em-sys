@extends('layouts.app')
@section('title', __('followup::lang.documents'))

@section('content')

    <section class="content-header">
        <h1>
            <span>@lang('followup::lang.documents')</span>
        </h1>
    </section>
                    ...
                    @slot('tool')
                        <div class="box-tools">
                            <a class="btn btn-primary pull-right m-5 btn-modal"
                                href="{{ action('Modules\FollowUp\Http\Controllers\FollowupDocumentController@create') }}"
                                data-href="{{ action('Modules\FollowUp\Http\Controllers\FollowupDocumentController@create') }}"
                        ...
                        <table class="table table-bordered table-striped" id="document_table" style="margin-bottom: 100px;">
                            <thead>
                                <tr>
                                    ...
                                    <th>@lang('followup::lang.doc_name')</th>
