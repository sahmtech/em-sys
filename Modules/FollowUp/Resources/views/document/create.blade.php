<div class="modal-dialog modal-lg" id="add_document_model" role="document">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title"><i class="fas fa-plus"></i> @lang('followup::lang.add_document')</h4>
        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <section class="content">
                        ...
                        {!! Form::open([
                            'url' => action('Modules\FollowUp\Http\Controllers\FollowupDocumentController@store'),
                            'method' => 'post',
                            'id' => 'doc_add_form',
                        ]) !!}
