            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            {!! Form::label('documents', __('followup::lang.attachment_type')) !!}<span style="color: red; font-size:10px"> *</span>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                {!! Form::label('document', __('followup::lang.upload_attachment') . '  ') !!}<span style="color: red; font-size:10px"> *</span>
