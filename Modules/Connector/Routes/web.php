...
Route::middleware('web', 'authh', 'auth', 'CustomSetSessionData', 'language', 'timezone', 'CustomAdminSidebarMenu', 'CheckUserLogin')->prefix('connector')->group(function () {
...
Route::middleware('web', 'CustomSetSessionData', 'auth', 'language', 'timezone', 'CustomAdminSidebarMenu')->prefix('connector')->group(function () {
