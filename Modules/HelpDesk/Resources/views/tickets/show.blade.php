        ...
        <div class="col-md-12">
            <div class="col-md-3">
                <div class="custom_ticket_container box box-primary">
                    ...
                    <hr>
                    <div class="col-md-12">
                        <p>@lang('helpdesk::lang.requester'): {{ $ticket->user->first_name }} {{
                    ...
                    <div class="col-md-12">
                        <p>@lang('helpdesk::lang.last_update_date'): {{ $ticket->last_update_date ?? $ticket->created_at
                            }}</p>
                    </div>
                    <div class="clearfix"></div>
                    <div class="col-md-10">
        ...
        <div class="modal fade" id="addTicketReplyModal" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    {!! Form::open([
                    'url' => action([Modules\HelpDesk\Http\Controllers\HdTicketReplyController::class, 'store'],
                    [$ticket->id]),
