...
@section('company_title', __('accounting::lang.budget'))
...
@section('content')
    ...
    <section class="content">
        @component('components.widget', ['class' => 'box-solid'])
            @slot('tool')
                <div class="box-tools">
                    <button type="button" class="btn btn-block btn-primary" data-toggle="modal" data-target="#add_budget_modal">
    ...
    <div class="modal fade" id="add_budget_modal" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                {!! Form::open([
                    'url' => action('\Modules\Accounting\Http\Controllers\BudgetController@create'),
                    'method' => 'get',
                    'id' => 'add_budget_form',
                ]) !!}
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                {!! Form::number('financial_year', null, [
                                    'class' => 'form-control',
                                    'required',
                                    'placeholder' => __('accounting::lang.financial_year_for_the_budget'),
                                    'id' => 'financial_year',
                                ]) !!}
                            </div>
                        </div>
        ...
        $(document).ready(function() {
            $('#fiscal_year_picker').datepicker({
                ...
                window.location.href =
                    "{{ action('\Modules\Accounting\Http\Controllers\BudgetController@index') }}?financial_year=" +
