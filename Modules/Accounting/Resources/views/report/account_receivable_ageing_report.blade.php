...
@section('company_title', __('accounting::lang.account_recievable_ageing_report'))
...
@section('content')
    ...
    <section class="content-header">
        ...
        @endif
        <h1>@lang('accounting::lang.account_recievable_ageing_report')</h1>
    </section>
            ...
            $('#location_id').change(function() {
                if ($(this).val()) {
                    window.location.href =
                        "{{ route('accounting.account_receivable_ageing_report') }}?location_id=" + $(this)
                        .val();
                } else {
