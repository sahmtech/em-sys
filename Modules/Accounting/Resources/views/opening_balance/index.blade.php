            ...
            setTimeout(function(){
                $.ajax({
                    ...
                    success: function (res){
                        ...
                        if (debts > credits){
                            $('#opening_balance_table tbody').append('<tr role="row"><td class="text-red"><b>المعادلة غير متوازنة</b></td><td class="text-red sorting_1"></td><td  class="text-red"><b>'+debts+'</b></td><td  class="text-red"><b>'+credits+'</b></td><td  class="text-red"><b>زيادة بالمدين</b></td></tr>')
                        }
                        if (debts < credits){
                            $('#opening_balance_table tbody').append('<tr role="row"><td class="text-red"><b>المعادلة غير متوازنة</b></td><td class="text-red sorting_1"></td><td  class="text-red"><b>'+debts+'</b></td><td  class="text-red"><b>'+credits+'</b></td><td  class="text-red"><b>زيادة بالدائن</b></td></tr>')
                        }
                        if (debts === credits){
                            $('#opening_balance_table tbody').append('<tr role="row"><td class="text-green"><b>المعادلة متوازنة</b></td><td class="text-green sorting_1"></td><td  class="text-green"><b>'+debts+'</b></td><td  class="text-green"><b>'+credits+'</b></td><td  class="text-green"></td></tr>')
                        }
                    }
                })
            }, 2000);
