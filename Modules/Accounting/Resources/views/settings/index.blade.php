...
{{--                            </div>--}}
                    ...
                    <div class="tab-pane" id="auto_mapping_tab">
                        <div class="row">
                            <div class="col-md-12">
                                <br>
                                <table class="table table-striped" id="auto_mapping_table" style="width: 100% !important;">
                                    <thead>
                                    <tr>
                                        <th>@lang('messages.action')</th>
...
<script>
    ...
    $(document).on('click', '#auto_mapping_form .fa-plus-square', function(){
        ...
        $('#auto_mapping_form tbody').append('<tr><td><i class="fa fa-plus-square fa-2x text-primary cursor-pointer" data-id="'+counter+'"></i></td><td><select class="form-control accounts-dropdown account_id" style="width: 100%;" name="account_id['+counter+']"><option selected="selected" value="">يرجى الاختيار</option></select> </td> <td> <label class="radio-inline"><input value="credit" type="radio" name="type['+counter+']">@lang( 'accounting::lang.credit' )</label><label class="radio-inline"><input value="debit" type="radio" name="type['+counter+']" checked>@lang( 'accounting::lang.debit' )</label> </td> </tr>')
        $('select[name="account_id['+counter+']"]').select2({
            ajax: {
                url: '{{route("accounts-dropdown")}}',
                dataType: 'json',
