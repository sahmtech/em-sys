                    ...
                    <tbody>
                        @foreach ($accounts_transactions as $accounts_transaction)
                            <tr>
                                ...
                                @if ($accounts_transaction->partner_type == 'employees')
                                    <td>{{ $accounts_transaction->employee->first_name . ' ' . $accounts_transaction->employee->last_name . '-' . $accounts_transaction->employee->id_proof_number }}
                                    </td>
                                @elseif ($accounts_transaction->partner_type == 'customers_suppliers')
                                    <td>{{ $accounts_transaction->contact->supplier_business_name . '-' . $accounts_transaction->contact->contact_id }}
                                    </td>
                                @else
                                    <td>
                                        --
