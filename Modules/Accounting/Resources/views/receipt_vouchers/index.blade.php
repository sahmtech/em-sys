...
@section('content')
    ...
    <section class="content no-print">
        ...
        @component('components.widget', ['class' => 'box-solid'])
            @can('accounting.add_receipt_voucher')
                @slot('tool')
                    <div class="box-tools">
...
@push('javascript')
    <script>
                ...
                ajax: {
                    ...
                    "data": function ( d ) {
                        if($('#receipt_voucher_date_range_filter').val()) {
                            var start = $('#receipt_voucher_date_range_filter').data('daterangepicker').startDate.format('YYYY-MM-DD');
                            var end = $('#receipt_voucher_date_range_filter').data('daterangepicker').endDate.format('YYYY-MM-DD');
                            d.start_date = start;
                            d.end_date = end;
                        }
        ...
        $('#receipt_voucher_date_range_filter').daterangepicker(
            dateRangeSettings,
            function (start, end) {
                $('#receipt_voucher_date_range_filter').val(start.format(moment_date_format) + ' ~ ' + end.format(moment_date_format));
