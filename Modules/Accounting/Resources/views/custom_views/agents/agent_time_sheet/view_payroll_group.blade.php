@extends('layouts.app')
@section('title', __('agent.view_payroll_group'))
@section('content')
    <section class="content-header">
        <h1>
            @lang('agent.view_payroll_group')
...
@endsection
<style type="text/css">
    #payroll-group-table>thead>tr>th,
    #payroll-group-table>tbody>tr>th,
    #payroll-group-table>tfoot>tr>th,
    #payroll-group-table>thead>tr>td,
    #payroll-group-table>tbody>tr>td,
    #payroll-group-table>tfoot>tr>td {
