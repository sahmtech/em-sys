        ...
        @component('components.widget', ['class' => 'box-primary'])
            ...
            <div class="table-responsive">
                <div style="margin-bottom: 10px;">
                    @if (auth()->user()->hasRole('Admin#1') || auth()->user()->can('accounting.change_status'))
                        <button type="button" class="btn btn-warning change_status2">
                            @lang('request.change_status')
                        </button>
                    @endif
                    @if (auth()->user()->hasRole('Admin#1') || auth()->user()->can('accounting.return_the_request'))
        ...
        <div class="modal fade" id="addRequestModal" tabindex="-1" role="dialog" aria-labelledby="gridSystemModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    {!! Form::open(['route' => 'accounting.returnReq.store', 'enctype' => 'multipart/form-data']) !!}
...
@section('javascript')
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            //                 for (var i = 0; i < response.workflow
            //                     .length; i++) {

            //                     var status = response.workflow[i].status ?
            //                         response.workflow[i]
            //                         .status.toLowerCase() : 'grey';
            //                     var circle =
            //                         '<div class="workflow-circle ' +
            //                         status + '">';
            //                     circle += '<p class="department-name">' +
            //                         response.workflow[i]
            //                         .department + '</p>';
            //                     circle += '</div>';
            ...
            //                     '{{ __('request.worker_name') }}' +
            //                     ': ' + response
            //                     .user_info.worker_full_name + '</p>');
            //                 workerList.append('<p class="worker-info">' +
            //                     '{{ __('request.nationality') }}' +
            //                     ': ' + response
            ...
            //                     ': ' +
            //                     response.user_info.contract_end_date +
            //                     '</p>');
            //                 workerList.append('<p class="worker-info">' +
            //                     '{{ __('request.eqama_end_date') }}' +
            //                     ': ' +
            //                     response.user_info.eqama_end_date +
            //                     '</p>');
            //                 workerList.append('<p class="worker-info">' +
            //                     '{{ __('request.passport_number') }}' +
            //                     ': ' +
            //                     response.user_info.passport_number +
            //                     '</p>');
            ...
            //                 for (var j = 0; j < response.followup_processes
            //                     .length; j++) {
            //                     var activity = '<li>';
            ...
            //                         ': ' +
            //                         response.request_info.started_depatment
            //                         .name + '</p>';
            //                     activity += '<p>' +
            //                         '{{ __('request.created_user_name') }}' +
            //                         ': ' +
            //                         response.created_user_info
            //                         .created_user_full_name + '</p>';
            //                     activity += '<p>' +
            //                         '{{ __('essentials::lang.department_name') }}' +
            //                         ': ' +
            //                         response.followup_processes[j]
            //                         .department.name;

            //                     activity +=
            //                         '<p class="{{ __('essentials::lang.status') }} ' +
            //                         response.followup_processes[j].status
            //                         .toLowerCase() +
            //                         '">' +
            ...
            //                     activity += '<p>' +
            //                         '{{ __('essentials::lang.reason') }}' +
            //                         ': ';
            //                     if (response.followup_processes[j].reason) {
            //                         activity += '<strong>' + response
            //                             .followup_processes[j]
            //                             .reason + '</strong>';
            //                     } else {
            //                         activity +=
            //                             '{{ __('essentials::lang.not_exist') }}';
            //                     }
            //                     activity += '<p>' +
            //                         '{{ __('essentials::lang.note') }}' +
            //                         ': ';
            //                     if (response.followup_processes[j]
            //                         .status_note) {
            //                         activity += '<strong>' + response
            //                             .followup_processes[j]
            //                             .status_note + '</strong>';
            ...
            //                 for (var j = 0; j < response.attachments
            //                     .length; j++) {
            //                     var attachment = '<li>';
            ...
            //                     .replace(':requestId', response
            //                         .request_info.id));

            //                 $('#attachmentForm input[name="requestId"]')
            //                     .val(requestId);
