...
@push('javascript')
    <script>
                ...
                ajax: {
                    ...
                    "data": function ( d ) {
                        if($('#payment_voucher_date_range_filter').val()) {
                            var start = $('#payment_voucher_date_range_filter').data('daterangepicker').startDate.format('YYYY-MM-DD');
                            var end = $('#payment_voucher_date_range_filter').data('daterangepicker').endDate.format('YYYY-MM-DD');
                            d.start_date = start;
                            d.end_date = end;
                        }
        ...
        $('#payment_voucher_date_range_filter').daterangepicker(
            dateRangeSettings,
            function (start, end) {
                $('#payment_voucher_date_range_filter').val(start.format(moment_date_format) + ' ~ ' + end.format(moment_date_format));
        ...
        $(document).on('change', '#payment_voucher_filter_customer_id, #payment_voucher_filter_account_id, #payment_voucher_filter_payment_status', function () {
            $('#payment_voucher_table').DataTable().ajax.reload();
        });
    </script>
    <script>
