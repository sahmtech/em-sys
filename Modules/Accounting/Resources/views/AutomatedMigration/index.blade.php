        ...
        @component('components.widget', ['class' => 'box-primary'])
            ...
            <div class="row" style="margin: 0px 0px 30px 0px">
                ...
                <div class="col-sm-3">
                    ...
                    {!! Form::label('account_sub_type', __('النوع') . '  ') !!}<span style="color: red; font-size:10px"> *</span>
                    <select class="form-control" name="account_sub_type_id" id="account_sub_type"style="padding: 3px" required>
                        <option value="">@lang('messages.please_select')</option>
                ...
                <div class="col-sm-3">
                    ...
                    {!! Form::label('account_sub_type', __('الحالة') . '  ') !!}<span style="color: red; font-size:10px"> *</span>
                    <select class="form-control" name="account_sub_type_id" id="account_sub_type"style="padding: 3px" required>
                        <option value="">@lang('messages.please_select')</option>
                        <option value="">@lang('accounting::lang.autoMigration.final')</option>
                    </select>
                </div>
