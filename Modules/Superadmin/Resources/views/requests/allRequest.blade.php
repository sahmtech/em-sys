                ...
                columns: [
   ...
   
                    {
                        ...
                        render: function (data, type, row) {
                            ...
                            if (data == 1 &&
                                (row.department_id == {{ $department1->id }} || row.department_id == {{ $department2->id }}) &&
                                row.status.toLowerCase() != 'trans(followup::lang.approved)' && row.status.toLowerCase() != 'tans(followup::lang.rejected)') {
